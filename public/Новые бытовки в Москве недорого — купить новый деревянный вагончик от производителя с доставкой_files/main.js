...
(!(function () {
  if (void 0 === redhelper) {
    ...
    (!(function (global, setTimeout) {
          ...
          for (k(); B.length; ) {
            if (((a = B.shift()), null === a[0]))
              return j(
                makeError(
                  'mismatch',
                  'Mismatched anonymous redhelper.define() module: ' +
                    a[a.length - 1]
                )
              );
            o(a);
      ...
      (redhelper.requirejs = requirejs),
      (redhelper.require = require),
      (redhelper.define = define));
  }
})(),
  redhelper.requirejs.config({
    baseUrl: '/connect/js',
    paths: {
      jquery:
        (window.redconnect && window.redconnect.url
          ? window.redconnect.url
          : '//web.redhelper.ru') + '/vendor/jquery.min',
    },
    map: {
  ...
  redhelper.define('jquery-private', ['jquery'], function (a) {
    return a.noConflict(!0);
  }),
  redhelper.define('lib/log', [], function () {
    function a(a) {
      this.message = a;
    }
    function b(a) {
    ...
    var i = { PRODUCTION: 'PRODUCTION', DEVELOPMENT: 'DEVELOPMENT' },
      j = {
        ERROR: 'ERROR',
        WARN: 'WARN',
        INFO: 'INFO',
      ...
      l = {
        maxLength: 1e3,
        maxLengthOverflowBuffer: 500,
        mode: ~location.href.indexOf('rc-dev-log-mode')
          ? i.DEVELOPMENT
          : i.PRODUCTION,
        level: j.INFO,
        messages: [],
        write: function (a, b) {
          if (!(g(a) < g(l.level))) {
            (k >= l.maxLength + l.maxLengthOverflowBuffer &&
              ((l.messages = l.messages.slice(-l.maxLength)),
              (k = l.maxLength)),
              k++);
            var c = f(a, b);
            (l.messages.push(c),
              l.mode == i.DEVELOPMENT && h(a).call(console, c));
          }
        },
        console: function () {
          for (var a in l.messages)
            l.messages.hasOwnProperty(a) && h('').call(console, l.messages[a]);
        },
        clear: function () {
          l.messages = [];
        },
  ...
  redhelper.define('lib/tracking', ['lib/log'], function (a) {
    var b = [],
      c = {
        init: function () {
          if (window.redconnect.tracking) {
            var d;
            for (var e in window)
              0 == e.indexOf('yaCounter') && (d = window[e]);
            c.hit = function (b, c) {
              c = c || 1;
              try {
                ('object' == typeof _gaq &&
                  _gaq.push &&
                  _gaq.push(['_trackEvent', 'RedConnect', b, b, c, !0]),
                  'function' == typeof ga &&
                    ga('send', {
                      hitType: 'event',
                      eventCategory: 'RedConnect',
                      eventAction: b,
                      eventLabel: b,
                      eventValue: c,
                      nonInteraction: !0,
                  ...
                  'function' == typeof gtag &&
                    gtag('event', b, { event_category: 'RedConnect' }),
                  window.dataLayer &&
                    window.dataLayer.push &&
                    window.dataLayer.push({ event: b }),
                  'object' == typeof d &&
                    d.reachGoal('RedConnect.' + b.replace(' ', '_')),
                  window.redhlpSettings &&
                    'function' == typeof window.redhlpSettings.onEvent &&
                    window.redhlpSettings.onEvent(b));
              } catch (b) {
                a.error(b);
              }
            };
            for (var f = 0, g = b.length; f < g; f++) c.hit(b[f][0], b[f][1]);
            b = [];
          } else ((c.hit = function () {}), (b = []));
        },
        hit: function (a, c) {
          b.push([a, c]);
        },
  ...
  redhelper.define('lib/country-names', [], function () {
    return {
      HAFGHANISTAN: 'AF',
      'ÅLAND ISLANDS': 'AX',
      ALBANIA: 'AL',
  ...
  redhelper.define('application/defaults', ['lib/country-names'], function (a) {
    return {
      basic: {
        copy: {
          link: '//redconnect.ru/?cp=p1',
          content:
            'Сервис предоставлен <span id="rc-popup-copyright-red">Red</span>Connect',
          free: "Бесплатная версия обратного звонка <span class='rc-name'>RedConnect</span>",
        },
        widgetId: '',
        url: '//web.redhelper.ru',
        uiVersion: 0,
        backend: '//web.redhelper.ru/rc',
        status: 'offline',
        letsTalkAt: void 0,
        language: 'ru',
        debugShowFunctionCalls: ~location.hash.indexOf(
          'rc_debugShowFunctionCalls'
        ),
        duration: 28,
        textMain: "Перезвоним <span class='rc-when'>за 28 секунд!</span>",
        textFreeMain: 'Перезвоним бесплатно!',
        textOffline: "Перезвоним <span class='rc-when'>за 28 секунд!</span>",
        textOfflineShort: 'Заказать обратный звонок',
        textButton: 'Заказать звонок',
        textPlaceholder: '+$code Ваш телефон',
        textClose: 'Закрыть',
        textSend: 'Отправить',
        textEdit: 'Изменить',
        textCancel: 'Отменить',
        textMessages: {
          ...
          wrongNumber: 'Проверьте правильность набранного номера',
          emailed: 'Ваша заявка успешно отправлена, ожидайте звонок оператора.',
          wait: 'Подождите...',
          callingOperator: 'Соединяем с оператором...',
          talkInProgress: 'Идёт разговор с оператором...',
          callingVisitor: 'Звоним на ваш телефон...',
          timeout: 'Подождите, оператор вам скоро позвонит...',
          operatorUnavailable:
            'Сейчас нет свободных операторов, мы позвоним вам в ближайшее возможное время.',
          visitorUnavailable:
            'Не удаётся дозвониться на ваш номер, проверьте правильность номера и что ваш телефон доступен.',
          operatorHangup: 'Оператор сбросил звонок.',
          connectionFailed:
            'Не удалось установить соединение, мы позвоним вам в ближайшее возможное время.',
          callCancelled: 'Звонок отменён',
          timePickerHeader: 'Выбор времени',
          timePickerText:
            'Сейчас операторы не работают.<br>Мы перезвоним в указанное время:',
          appointmentText: 'Мы перезвоним&nbsp;Вам',
        },
        noticeDuration: 3e3,
        colorMain: '#3fae2a',
        colorBack: '#363f43',
        ...
        tracking: !0,
        timeout: 2,
        disableAutoExpanding: !1,
        enabled: !0,
        disabledOffline: !1,
        popup: {
          enabled: !1,
          text: 'Вы можете оставить свой телефон и вам перезвонят в течение 28 секунд!',
          offlineText:
        ...
        feedbackEnabled: !0,
        feedbackStartTimeout: 2,
        feedbackTimeout: 16,
        feedback: {
          leaveComment: 'Оставить комментарий оператору',
          yes: 'Да',
          no: 'Нет',
          reachQuestion: 'Вы получили звонок?',
          likeQuestion: 'Оцените звонок оператора:',
          commentQuestion: 'Напишите в двух словах, что вам не понравилось:',
          commentQuestionLiked:
            'Вы можете оставить комментарий о работе оператора:',
          completeMessage: 'Спасибо!',
          exitWarning:
            'Вы ещё не оставили отзыв об обратном звонке, вы уверены, что хотите уйти со страницы?',
          excuse:
            'Похоже, у оператора возникли проблемы с дозвоном, мы отправили ему письмо с вашими контактами и он свяжется с вами в ближайшее время.',
        },
        time: {
          months: [
            'янв.',
  ...
  redhelper.define('languages/en', [], function () {
    return {
      language: 'en',
      copy: {
        link: 'http://redconnect.us/',
        content:
          'Powered by <span id="rc-popup-copyright-red">Red</span>Connect',
        free: 'Powered by <span class="rc-name">RedConnect</span>',
      },
      url: '//web.redhelper.com',
      backend: '//web.redhelper.com/rc',
      duration: 26,
      textMain: "We'll call you in 26 seconds!",
      textFreeMain: "We'll call you back for free!",
      textOffline: "We'll call you <span class='rc-when'>in 26 seconds!</span>",
      textOfflineShort: 'Make a call request',
      textButton: 'Request a call',
      textPlaceholder: '+$code - your phone',
      textClose: 'Close',
      textSend: 'Send',
      textEdit: 'Edit',
      textCancel: 'Cancel',
      textMessages: {
        ...
        wrongNumber:
          "You've entered a wrong number. Please, check the number and try again.",
        emailed: 'You request sent successfully',
        wait: 'Please, wait...',
        callingOperator: 'Connecting to our agent...',
        talkInProgress: "You're talking now with our agent...",
        callingVisitor: 'Calling to you...',
        timeout: 'Please wait, our agent will call you soon...',
        operatorUnavailable:
          "There are no agents available at the moment, we'll call you back as soon as possible.",
        visitorUnavailable:
          'Failed to call to the specified number, please check the number and make sure that your phone is available',
        operatorHangup: 'The call was rejected.',
        connectionFailed:
          "Failed to establish connection, we'll call you back as soon as possible.",
        callCancelled: 'The call was canceled',
        timePickerHeader: 'Select time',
        timePickerText:
          "Our agents are not working now.<br>We'll call you when you choose:",
        appointmentText: "We'll call you",
      },
      countryCode: 'us',
      popup: {
        text: "Enter your phone and we'll call you in 26 seconds!",
        offlineText:
          "Let's appoint a call. Select the time and enter your phone and we'll call you.",
      },
      feedback: {
        leaveComment: 'Please, leave a comment here',
        yes: 'Yes',
        no: 'No',
        reachQuestion: 'Have you received a call?',
        ...
        exitWarning:
          "You haven't left a feedback about the call you've requested, do you want to leave the page anyway?",
        excuse:
          "Our agents seem to have some difficulties in calling you back, we've sent them an email with your phone and they'll contact you as soon as possible.",
      },
      time: {
        months: [
          'Jan.',
  ...
  redhelper.define('languages/localization', ['languages/en'], function (a) {
    return {
      getLanguageSettings: function (b) {
        return 'en' == b ? a : null;
      },
    };
  }),
  redhelper.define('common/extensions/browserDetect', [], function () {
    var a = {
      init: function () {
  ...
  (function (a) {
    'function' == typeof redhelper.define && redhelper.define.amd
      ? redhelper.define('lib/inputtel', ['jquery'], function (b) {
          a(b, window, document);
        })
    ...
    function e(b, c) {
      ((this.element = b),
        ...
        (this._defaults = h),
        (this.ns = '.' + f + g++),
        (this.isGoodBrowser = Boolean(b.setSelectionRange)),
        (this.hadInitialPlaceholder = Boolean(a(b).attr('placeholder'))),
        (this._name = f),
        this.init());
    }
    var f = 'intlTelInput',
    ...
    (a(b).load(function () {
      ...
      (e.prototype = {
        init: function () {
          'auto' == this.options.defaultCountry
            ? ((this.options.defaultCountry = ''), this._ready())
            : this._ready();
        },
        _ready: function () {
          (this.options.nationalMode && (this.options.autoHideDialCode = !1),
            ...
            b.innerWidth < 500 && (this.options.responsiveDropdown = !0),
        ...
        _setInstanceCountryData: function () {
          ...
          if (this.options.onlyCountries.length)
            for (this.countries = [], b = 0; b < k.length; b++)
              -1 != a.inArray(k[b].iso2, this.options.onlyCountries) &&
                this.countries.push(k[b]);
          ...
          for (this.countryCodes = {}, b = 0; b < this.countries.length; b++) {
            ...
            if (
              ...
              for (var d = 0; d < c.areaCodes.length; d++)
                this._addCountryCode(c.iso2, c.dialCode + c.areaCodes[d]);
          }
        },
        ...
        _generateMarkup: function () {
          ((this.telInput = a(this.element)),
            this.telInput.wrap(a('<div>', { class: '_27' })));
          var b = a('<div>', { class: 'flag-dropdown' }).insertAfter(
              this.telInput
            ),
            c = a('<div>', { class: 'selected-flag' }).appendTo(b);
          ((this.selectedFlagInner = a('<div>', { class: 'flag' }).appendTo(c)),
            a('<div>', { class: 'arrow' }).appendTo(this.selectedFlagInner),
        ...
        _setInitialState: function () {
          ...
          if (this._getDialCode(a)) this._updateFlagFromNumber(a);
            ...
            var b;
            ((b = this.options.defaultCountry
              ? this._getCountryData(this.options.defaultCountry, !1, !1)
              : this.preferredCountries.length
        ...
        _initListeners: function () {
          ...
          (d.length &&
            d.on('click' + this.ns, function (a) {
              c.countryList.hasClass('hide')
                ? c.telInput.focus()
                : a.preventDefault();
            }),
            this.selectedFlagInner.parent().on('click' + this.ns, function (a) {
              c.countryList.hasClass('hide') &&
                !c.telInput.prop('disabled') &&
                c._showDropdown();
            }),
        ...
        _initKeyListeners: function () {
          ...
          (this.options.autoFormat &&
            this.telInput.on('keypress' + this.ns, function (c) {
              if (c.which >= i.SPACE && !c.metaKey && b.intlTelInputUtils) {
                c.preventDefault();
                var d =
                    (c.which >= i.ZERO && c.which <= i.NINE) ||
                    c.which == i.PLUS,
                  e = a.telInput[0],
                  f = a.isGoodBrowser && e.selectionStart == e.selectionEnd,
                  g = a.telInput.attr('maxlength');
                if ((!g || a.telInput.val().length < g) && (d || f)) {
                  var h = d ? String.fromCharCode(c.which) : null;
                  a._handleInputKey(h, !0);
                }
            ...
            this.telInput.on('keyup' + this.ns, function (c) {
              if (c.which == i.ENTER);
                ...
                var d =
                    c.which == i.CTRL || c.which == i.CMD1 || c.which == i.CMD2,
                  e = a.telInput[0],
                  f = a.isGoodBrowser && e.selectionStart == e.selectionEnd,
                  g =
                    a.isGoodBrowser &&
                    e.selectionStart == a.telInput.val().length;
                if (
                  (((c.which == i.DEL && !g) ||
                    c.which == i.BSPACE ||
                    (d && f)) &&
                    a._handleInputKey(null, d && g),
                  !a.options.nationalMode)
                ) {
                  var h = a.telInput.val();
                  if ('+' != h.substr(0, 1)) {
                    var j = a.isGoodBrowser ? e.selectionStart + 1 : 0;
                    (a.telInput.val('+' + h),
                      a.isGoodBrowser && e.setSelectionRange(j, j));
                  }
                }
        ...
        _handleInputKey: function (a, b) {
          ...
          if (this.isGoodBrowser) {
            ...
            ((e = g == h),
              a
                ? ((c = c.substr(0, f.selectionStart) + a + c.substring(g, h)),
                  e || (d = g + (c.length - h)))
                : (d = f.selectionStart));
          } else a && (c += a);
          (this.setNumber(c, b),
            this.isGoodBrowser &&
              (e && (d = this.telInput.val().length),
        ...
        _initFocusListeners: function () {
          ...
          (this.options.autoHideDialCode &&
            this.telInput.on('mousedown' + this.ns, function (b) {
              a.telInput.is(':focus') ||
                a.telInput.val() ||
                (b.preventDefault(), a.telInput.focus());
            }),
            this.telInput.on('focus' + this.ns, function () {
              var c = a.telInput.val();
              (a.telInput.data('focusVal', c),
                a.options.autoHideDialCode &&
                  (c ||
                    (a._updateVal('+' + a.selectedCountryData.dialCode, !0),
                    a.telInput.one('keypress.plus' + a.ns, function (c) {
                      if (c.which == i.PLUS) {
                        var d =
                          a.options.autoFormat && b.intlTelInputUtils
                            ? '+'
                            : '';
                        a.telInput.val(d);
                      }
            ...
            this.telInput.on('blur' + this.ns, function () {
              if (a.options.autoHideDialCode) {
                var c = a.telInput.val();
                if ('+' == c.substr(0, 1)) {
                  var d = a._getNumeric(c);
                  (d && a.selectedCountryData.dialCode != d) ||
                    a.telInput.val('');
                }
                a.telInput.off('keypress.plus' + a.ns);
              }
              a.options.autoFormat &&
                b.intlTelInputUtils &&
                a.telInput.val() != a.telInput.data('focusVal') &&
                a.telInput.trigger('change');
            }));
        },
        ...
        _showDropdown: function () {
          ...
          (this._highlightListItem(a),
            ...
            this.countryList.removeClass('rc-country-list-down'),
            this.countryList.offset().top < 0
              ? this.countryList.addClass('rc-country-list-down')
              : this.countryList.removeClass('rc-country-list-down'));
        },
        _setDropdownPosition: function () {
          var c = this.telInput.offset().top,
            d = a(b).scrollTop(),
            e =
              c + this.telInput.outerHeight() + this.dropdownHeight <
              d + a(b).height(),
        ...
        _bindDropdownListeners: function () {
          ...
          a(c).on('keydown' + this.ns, function (a) {
            (a.preventDefault(),
              a.which == i.UP || a.which == i.DOWN
                ? b._handleUpDownKey(a.which)
                : a.which == i.ENTER
                  ? b._handleEnterKey()
                  : a.which == i.ESC
                    ? b._closeDropdown()
        ...
        _handleUpDownKey: function (a) {
          ...
          c.length &&
            (c.hasClass('divider') && (c = a == i.UP ? c.prev() : c.next()),
            this._highlightListItem(c),
            this._scrollTo(c));
        },
          ...
          for (var b = 0; b < this.countries.length; b++)
            if (this._startsWith(this.countries[b].name, a)) {
              var c = this.countryList
                .children('[data-country-code=' + this.countries[b].iso2 + ']')
                .not('.preferred');
          ...
          if (b) {
            ...
            if (this.selectedCountryData)
              for (var e = 0; e < c.length; e++)
                c[e] == this.selectedCountryData.iso2 && (d = !0);
        ...
        _updatePlaceholder: function () {
          if (b.intlTelInputUtils && !this.hadInitialPlaceholder) {
            var a = this.selectedCountryData.iso2,
              ...
              d = intlTelInputUtils.getExampleNumber(
                a,
                this.options.nationalMode,
                c
              );
        ...
        _updateDialCode: function (b, c) {
          var d,
            e = this.telInput.val();
          if (
            ((b = '+' + b), this.options.nationalMode && '+' != e.substr(0, 1))
          )
            d = e;
          else if (e) {
          ...
          if ('+' == b.charAt(0))
            for (var d = '', e = 0; e < b.length; e++) {
              ...
              if (
                a.isNumeric(f) &&
                ((d += f),
                this.countryCodes[d] && (c = b.substr(0, e + 1)),
                4 == d.length)
              )
                break;
            }
        ...
        isValidNumber: function () {
          ...
          return (
            !(/[a-zA-Z]/.test(c) || !b.intlTelInputUtils) &&
        ...
        loadUtils: function (b) {
          ...
          !a.fn[f].loadedUtilsScript &&
            ...
            a.ajax({
              url: c,
              success: function () {
                a('._27 input').intlTelInput('utilsLoaded');
              },
              dataType: 'script',
              cache: !0,
            }));
        ...
        selectCountry: function (a) {
          this.selectedFlagInner.hasClass(a) ||
            (this._selectFlag(a),
        ...
        if ('string' == typeof b && '_' !== b[0] && 'init' !== b) {
          ...
          return (
            this.each(function () {
              ...
              (d instanceof e &&
                'function' == typeof d[b] &&
                (g = d[b].apply(d, Array.prototype.slice.call(c, 1))),
  ...
  redhelper.define('lib/inputtel-util', [], function () {
    !(function () {
      function a(a, b) {
        var c = a.split('.'),
          d = na;
      ...
      function g(a, b, c) {
        for (
          this.ua = a, this.na = b.name || null, this.m = {}, a = 0;
          a < c.length;
          a++
        )
          ((b = c[a]), (this.m[b.i] = b));
      ...
      function j() {
        ((this.c = {}), (this.m = this.q().m), (this.f = this.ma = null));
      }
      function k(a, b) {
        for (var c = h(a.q()), d = 0; d < c.length; d++) {
          var e = c[d],
            f = e.i;
          if (null != b.c[f]) {
            a.f && delete a.f[e.i];
            var g = 11 == e.o || 10 == e.o;
            if (e.ea)
              for (var e = l(b, f) || [], i = 0; i < e.length; i++)
                q(a, f, g ? e[i].clone() : e[i]);
            else
              ((e = l(b, f)),
                g
                  ? (g = l(a, f))
      ...
      function q(a, b, c) {
        (a.c[b] || (a.c[b] = []), a.c[b].push(c), a.f && delete a.f[b]);
      }
      function r(a, b) {
        (delete a.c[b], a.f && delete a.f[b]);
      }
      function s(a, b) {
        ((a.xa = b),
          (a.q = function () {
      ...
      function C(a) {
        ...
        return (
          0 <= b
            ? ((a = a.substring(b)),
              (a = a.replace(Ca, '')),
              0 <= (b = a.search(Ba)) && (a = a.substring(0, b)))
            : (a = ''),
          a
        );
      }
      function D(a) {
        return !(2 > a.length) && Y(Fa, a);
      }
      function E(a) {
        return Y(Da, a) ? G(a, wa) : G(a, va);
      }
      function F(a) {
        var b = E(a.toString());
        (a.clear(), a.append(b));
      ...
      function G(a, b) {
        for (var d, e = new c(), f = a.length, g = 0; g < f; ++g)
          ((d = a.charAt(g)), null != (d = b[d.toUpperCase()]) && e.append(d));
        return e.toString();
      }
      function H(a) {
      ...
      function N(a, b) {
        ...
        var c = a.va[b];
        if (null == c) {
          if (null == (c = ua[b])) return null;
          ((c = new A().v(v.q(), c)), (a.va[b] = c));
        }
        return c;
      }
      function O(a, b) {
        return Y(n(b, 3), a) && Y(n(b, 2), a);
      }
      function P(a, b) {
        if (null == b) return null;
        var c = b.k(),
        ...
        if (null == c) c = null;
          ...
          a: {
            for (var d, e = J(b), f = c.length, g = 0; g < f; g++) {
              d = c[g];
              var h = N(a, d);
              if (null != h.c[23]) {
      ...
      function S(a, b) {
        return Y(a, b) ? 0 : 0 == b.search(a) ? 3 : 2;
      }
      function T(a, b) {
        var c = a.toString();
        if (0 == c.length || '0' == c.charAt(0)) return 0;
        for (var d, e = c.length, f = 1; 3 >= f && f <= e; ++f)
          if ((d = parseInt(c.substring(0, f), 10)) in ta)
      ...
      function U(a, b, d, e, f) {
        ...
        if (0 == h.length) g = 20;
          ...
          ((h = h.replace(ya, '')), a.clear(), a.append(E(h)), (g = 1));
        else {
          if (
            ((h = new RegExp(g)), F(a), (g = a.toString()), 0 == g.search(h))
          ) {
            var h = g.match(h)[0].length,
              i = g.substring(h).match(za);
            i && null != i[1] && 0 < i[1].length && '0' == G(i[1], va)
              ? (g = !1)
        ...
        if (
          ...
          if (
            ...
            (b = j.toString()),
            (i = n(i, 3)),
            (!Y(h, a.toString()) && Y(h, b)) || 3 == S(i, a.toString()))
          )
            return (d.append(b), e && p(f, 6, 10), f.aa(g), g);
        }
        return (f.aa(0), 0);
      }
      function V(a, b, c) {
        ...
        if (
          ...
          var g,
            h = RegExp;
          ((g = m(b, 1)), (g = n(g, 2)), (h = new h(g)), (g = Y(h, d)));
          var i = e.length - 1;
          ((b = m(b, 16)),
            null == b || 0 == b.length || null == e[i] || 0 == e[i].length
              ? (g && !Y(h, d.substring(e[0].length))) ||
      ...
      function X(a, b, d, e) {
        ...
        if (0 < g) {
          ...
          ((h = b.indexOf('tel:')),
            f.append(b.substring(0 <= h ? h + 4 : 0, g)));
        } else f.append(C(b));
        if (
          ((g = f.toString()),
          (h = g.indexOf(';isub=')),
        ...
        if (
          ((g = f.toString()),
          !(H(d) || (null != g && 0 < g.length && ya.test(g))))
        )
          throw 'Invalid country calling code';
        ((g = new x()), e && p(g, 5, b));
        a: {
          if (
            ((b = f.toString()),
            0 <= (h = b.search(Ea)) && D(b.substring(0, h)))
          )
            for (var i = b.match(Ea), j = i.length, k = 1; k < j; ++k)
        ...
        try {
          ...
          if ('Invalid country calling code' != a || !ya.test(j)) throw a;
          if (((j = j.replace(ya, '')), 0 == (i = U(j, h, b, e, g)))) throw a;
        }
        if (
          (0 != i
            ? (f = Q(i)) != d && (h = I(a, i, f))
        ...
        if (
          (null != h &&
            ...
            (h = m(h, 1)),
            (h = n(h, 3)),
            2 != S(h, f) && ((b = d), e && p(g, 7, a.toString()))),
          (e = b.toString()),
          2 > (a = e.length))
        )
          throw 'The string supplied is too short to be a phone number';
        ...
        if (1 < e.length && '0' == e.charAt(0)) {
          for (p(g, 4, !0), a = 1; a < e.length - 1 && '0' == e.charAt(a); )
            a++;
          1 != a && p(g, 8, a);
        }
      ...
      function Z(a) {
        ((this.qa = ' '),
          ...
          (this.g = []),
          (this.ja = a),
          (this.wa = this.h = $(this, this.ja)));
      }
      function $(a, b) {
        var c = H(b) ? R(a.pa, b) : 0,
          c = N(a.pa, Q(c));
        return null != c ? c : Ia;
      }
      function _(a) {
        for (var b = a.g.length, c = 0; c < b; ++c) {
          ...
          if (-1 != h.indexOf('|')) f = !1;
            ...
            (j.length < i.b.e.length
              ? (i = '')
              : ((h = j.replace(new RegExp(h, 'g'), g)),
                (i = h = h.replace(RegExp('9', 'g'), i.qa))),
              0 < i.length ? (f.p.append(i), (f = !0)) : (f = !1));
          }
          if (f) return ((a.ba = e), (a.ga = Ma.test(m(d, 4))), (a.$ = 0), !0);
        }
        return (a.l = !1);
      }
      function aa(a, b) {
      ...
      function ba(a, b) {
        return ((a.ia = ca(a, b)), a.ia);
      }
      function ca(a, b) {
        a.j.append(b);
        var c = b;
        if (za.test(c) || (1 == a.j.e.length && xa.test(c))) {
          var d,
            c = b;
          ('+' == c
            ? ((d = c), a.t.append(c))
            : ((d = va[c]), a.t.append(d), a.b.append(d)),
            (b = d));
        } else ((a.l = !1), (a.la = !0));
        if (!a.l) {
          if (!a.la)
        ...
        switch (a.t.e.length) {
          ...
          case 2:
            return a.j.toString();
          case 3:
            if (!ja(a)) return ((a.n = ia(a)), ga(a));
            a.w = !0;
          default:
            return a.w
              ? (ka(a) && (a.w = !1), a.d.toString() + a.b.toString())
              : 0 < a.g.length
                ? ((c = la(a, b)),
                  (d = ea(a)),
                  0 < d.length
                    ? d
                    : (aa(a, a.b.toString()),
                      _(a) ? ha(a) : a.l ? fa(a, c) : a.j.toString()))
                : ga(a);
        }
      }
      function da(a) {
        return ((a.l = !0), (a.w = !1), (a.g = []), ga(a));
      }
      function ea(a) {
        for (var b = a.b.toString(), c = a.g.length, d = 0; d < c; ++d) {
          ...
          if (new RegExp('^(?:' + f + ')$').test(b))
            return (
              (a.ga = Ma.test(m(e, 4))),
              (b = b.replace(new RegExp(f, 'g'), m(e, 2))),
              fa(a, b)
            );
        }
        return '';
      ...
      function ga(a) {
        ...
        if (3 <= b.length) {
          for (
            var c = a.s && 0 < o(a.h, 20) ? l(a.h, 20) || [] : l(a.h, 19) || [],
              d = c.length,
              e = 0;
            e < d;
            ++e
            ...
            var f,
              g = c[e];
            ((f = null == a.h.c[12] || a.s || m(g, 6)) ||
              ((f = n(g, 4)), (f = 0 == f.length || Ha.test(f))),
              f && ((f = n(g, 2)), La.test(f) && a.g.push(g)));
          }
          return (
            aa(a, b),
            (b = ea(a)),
            0 < b.length ? b : _(a) ? ha(a) : a.j.toString()
          );
        }
        return fa(a, b);
      }
      function ha(a) {
        var b = a.b.toString(),
          c = b.length;
        if (0 < c) {
          for (var d = '', e = 0; e < c; e++) d = la(a, b.charAt(e));
          return a.l ? fa(a, d) : a.j.toString();
        }
        return a.d.toString();
      }
      function ia(a) {
          ...
          1 != a.h.sa()
            ...
            : ((b = a.b.toString()),
              (b =
                ...
                '1' != b.charAt(1))),
          b
            ? ((d = 1), a.d.append('1').append(' '), (a.s = !0))
            : null != a.h.c[15] &&
              ((b = new RegExp('^(?:' + m(a.h, 15) + ')')),
              null != (b = c.match(b)) &&
                null != b[0] &&
                0 < b[0].length &&
                ((a.s = !0), (d = b[0].length), a.d.append(c.substring(0, d)))),
          a.b.clear(),
          a.b.append(c.substring(d)),
          c.substring(0, d)
        );
      }
      function ja(a) {
        var b = a.t.toString(),
          c = new RegExp('^(?:\\+|' + m(a.h, 11) + ')'),
          c = b.match(c);
        return (
          null != c &&
          null != c[0] &&
      ...
      function ka(a) {
        ...
        return (
          ...
          (b = Q(d)),
          '001' == b ? (a.h = N(a.pa, '' + d)) : b != a.ja && (a.h = $(a, b)),
          a.d.append('' + d).append(' '),
          (a.n = ''),
          !0)
        );
      ...
      function la(a, b) {
        ...
        return (1 == a.g.length && (a.l = !1), (a.ba = ''), a.j.toString());
      }
      var ma,
        na = this;
      ((ma = c.prototype),
      ...
      ((i.prototype.getName = function () {
        ...
        (ma.q = function () {
          ...
          if (!(a = b.ra)) {
            ...
            var d = [],
              e = a[0];
            for (c in a) 0 != c && d.push(new i(0, c, a[c]));
            ((c = new g(b, e, d)), (a = b.ra = c));
          }
          return a;
        }),
        (ma.has = function (a) {
        ...
        (ma.clone = function () {
          ...
          return (a != this && ((a.c = {}), a.f && (a.f = {}), k(a, this)), a);
        }),
        b(t, j),
        b(u, j),
        b(v, j),
        ...
        b(w, j),
        (w.prototype.getMetadata = function (a) {
          return m(this, 1, a);
        }),
        s(t, {
        ...
        s(v, {
          ...
          1: { name: 'general_desc', required: !0, a: 11, type: u },
          2: { name: 'fixed_line', required: !0, a: 11, type: u },
          3: { name: 'mobile', required: !0, a: 11, type: u },
          4: { name: 'toll_free', required: !0, a: 11, type: u },
          5: { name: 'premium_rate', required: !0, a: 11, type: u },
          6: { name: 'shared_cost', required: !0, a: 11, type: u },
          7: { name: 'personal_number', required: !0, a: 11, type: u },
          8: { name: 'voip', required: !0, a: 11, type: u },
          21: { name: 'pager', required: !0, a: 11, type: u },
          25: { name: 'uan', required: !0, a: 11, type: u },
          27: { name: 'emergency', required: !0, a: 11, type: u },
          28: { name: 'voicemail', required: !0, a: 11, type: u },
          24: {
          ...
          19: { name: 'number_format', fa: !0, a: 11, type: t },
          20: { name: 'intl_number_format', fa: !0, a: 11, type: t },
          22: {
        ...
        s(w, {
          ...
          1: { name: 'metadata', fa: !0, a: 11, type: v },
        }),
        b(x, j),
        ...
        (x.prototype.getExtension = function () {
          return m(this, 3);
        }),
        s(x, {
        ...
        (y.prototype.v = function (a) {
          throw (new a.ua(), Error('Unimplemented'));
        }),
        (y.prototype.da = function (a, b) {
          if (11 == a.o || 10 == a.o)
            return b instanceof j ? b : this.v(a.oa.q(), b);
        ...
        (z.prototype.v = function (a, b) {
          var c = new a.ua();
          return ((c.ma = this), (c.c = b), (c.f = {}), c);
        }),
        b(A, z),
        (A.prototype.za = !1),
        (A.prototype.da = function (a, b) {
          return 8 == a.o ? !!b : y.prototype.da.apply(this, arguments);
        }),
      ...
      var ta = {
        ...
        ua = {
          ...
          CN: [
            ,
            [, , '[1-7]\\d{6,11}|8[0-357-9]\\d{6,9}|9\\d{7,9}', '\\d{4,12}'],
            [
              ,
              ,
          ...
          ME: [
            ...
            [
              [
                ...
                '(\\d{2})(\\d{3})(\\d{3})',
                '$1 $2 $3',
                ['[2-57-9]|6[3789]', '[2-57-9]|6(?:[389]|7(?:[0-8]|9[3-9]))'],
                '0$1',
                '',
                0,
              ],
      ...
      ((B.prototype.format = function (a, b) {
        ...
        a: {
          for (
            ...
            var j = o(g, 3);
            if (
              (0 == j || 0 == d.search(m(g, 3, j - 1))) &&
              ((j = new RegExp(m(g, 1))), Y(j, d))
            ) {
              f = g;
              break a;
            }
      ...
      ((Z.prototype.clear = function () {
        ((this.ia = ''),
          ...
          (this.g = []),
          (this.ga = !1),
          this.h != this.wa && (this.h = $(this, this.ja)));
      }),
        a('intlTelInputUtils', {}),
        a('intlTelInputUtils.formatNumber', function (a, b, c) {
          try {
            var d = a.replace(/\D/g, '');
            '+' == a.substr(0, 1) && (d = '+' + d);
            var e = new Z(b);
            ...
            for (var f, g = 0; g < d.length; g++) {
              if (
                ((f = ba(e, d.charAt(g))),
                b && f.length <= b.length && -1 == f.indexOf(' '))
              )
                return b;
              b = f;
            }
        ...
        a('intlTelInputUtils.formatNumberE164', function (a, b) {
          try {
            var c = B.r(),
              d = W(c, a, b);
            return c.format(d, 0);
        ...
        a('intlTelInputUtils.getValidationError', function (a, b) {
          try {
            var c,
              d = B.r(),
              e = W(d, a, b),
        ...
        a('intlTelInputUtils.isValidNumber', function (a, b) {
          try {
            var c,
              d = B.r(),
              e = W(d, a, b),
  ...
  redhelper.define('lib/btoa', [], function () {
    void 0 === window.btoa &&
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e) {
      ...
      function g() {
        var a = (window.RedHelper || {}).session;
        return a
          ? (a.referrer || (a.referrer = document.referrer),
            {
              ip: a.ip,
              timeOnSite: a.time,
              referrer: (a.referrer || '').substr(0, 2048),
              visits: a.visits,
              viewedPages: a.viewedPages,
              country: a.country,
              city: a.city,
              countryRu: a.country_ru,
              cityRu: a.city_ru,
      ...
      function i() {
        ...
        if (k.free) {
          ...
          ((k.popup.enabled = !1), (k.buttonWidget.enabled = !1));
        }
      }
      function j() {
        (~k.marginX.indexOf('%') &&
          parseInt(k.marginX.replace('%', '')) > 50 &&
          ((k.position = k.position.replace('right', 'left')),
          (k.marginX = 100 - +k.marginX.replace('%', '') + '%')),
          ~k.marginY.indexOf('%') &&
            parseInt(k.marginY.replace('%', '')) > 50 &&
            ((k.position = k.position.replace('bottom', 'top')),
            (k.marginY = 100 - +k.marginY.replace('%', '') + '%')),
          '0%' == k.marginX &&
            (k.marginX = ~k.position.indexOf('left') ? '27px' : '14px'),
          '0%' == k.marginY &&
            (k.marginY = ~k.position.indexOf('top') ? '27px' : '14px'),
          'transparent' == k.buttonWidget.buttonStyle &&
            ((k.buttonWidget.colorBack = '#363e43'),
            (k.buttonWidget.colorBorder = 'transparent')));
      }
      var k = window.redconnect,
        l = g();
      ((l.page = (location.href || '').substr(0, 2048)),
        (l.browser = e.browser + ' ' + e.version + ' (' + e.OS + ')'));
      var m = c.basic;
      return (
        (m.trackEvent = function (a, c) {
          b.hit(a, c);
        }),
        (m.log = a),
        (m.userInfo = l),
        (m.vid = f()),
        h(k, d.getLanguageSettings(k.language)),
        h(k, m),
        i(),
        j(),
        b.init(),
  ...
  redhelper.define('view/color-scheme', ['application/api'], function (a) {
    var b = {
      isDark: function (a) {
        ((a = a.replace('#', '')),
        ...
        return Math.sqrt(b * b * 0.241 + c * c * 0.391 + d * d * 0.068) <= 160;
      },
      rgbStringToIntArray: function (a) {
        return (
          (a = a.replace('#', '')),
          3 == a.length && (a = a.replace(/(.)/g, '$1$1')),
          [
      ...
      multiply: function (a, c) {
        for (var d = b.rgbStringToIntArray(a), e = 0; e < 3; e++)
          d[e] = Math.round(d[e] * c);
        return 'rgb(' + d.join(',') + ')';
      },
      colorToRgba: function (a, c) {
        return 'rgba(' + b.rgbStringToIntArray(a).join(',') + ', ' + c + ')';
      },
      apply: function () {},
    };
    return b;
  }),
  redhelper.define('text', ['module'], function (a) {
    function b(a, b) {
      ...
      (d = {
        ...
        write: function (a, b, c, e) {
          if (p.hasOwnProperty(b)) {
            ...
            c.asModule(
              a + '!' + b,
              "redhelper.define(function () { return '" + f + "';});\n"
            );
          }
        },
  ...
  redhelper.define('text!common/../../connect/template.html', [], function () {
    return '<template>\n\n\t<div id="rc-overlay" style="display: none;"></div>\n\n\t<div id="rc-popup" style="display: none;">\n\t\t<div id="rc-popup-close" class="rc-can-press"></div>\n\t\t<div id="rc-popup-text">\n\t\t\t<span class="rc-txt">Вы можете оставить свой<br/> телефон и вам перезвонят в<br/> течение 28 секунд!</span>\n\t\t</div>\n\t\t<div id="rc-popup-form" class="rc-parent-form">\n\t\t\t<div id="rc-popup-time-picker">\n\t\t\t\t<select id="rc-popup-time-picker-date"></select>\n\t\t\t\t<span class="rc-txt"></span>\n\t\t\t\t<select id="rc-popup-time-picker-hour"></select>\n\t\t\t\t<span class="rc-txt">:</span>\n\t\t\t\t<select id="rc-popup-time-picker-minute"></select>\n\t\t\t</div>\n\t\t\t<div id="rc-popup-form-field">\n\t\t\t\t<div id="rc-popup-form-input-warning">\n\t\t\t\t\t<div id="rc-popup-form-input-warning-header"><span class="rc-txt">Внимание!</span></div>\n\t\t\t\t\t<div id="rc-popup-form-input-warning-mid">\n\t\t\t\t\t\t<span class="rc-txt">Проверьте правильность набранного номера</span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div id="rc-popup-form-input-warning-bottom"></div>\n\t\t\t\t</div>\n\t\t\t\t<iframe id="rc-popup-connector-frame"></iframe>\n\t\t\t\t<div class="rc-call-progress">\n\t\t\t\t\t<div class="rc-progress-drag"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div id="rc-popup-form-button" class="rc-trigger rc-can-press"></div>\n\t\t</div>\n\t\t<div id="rc-popup-copyright">\n\t\t\t<a id="rc-popup-copyright-wrap" href="//redconnect.ru/?cp=p1" target="_blank">\n\t\t\t\t<span class="rc-txt">Сервис предоставлен <span id="rc-popup-copyright-red">Red</span>Connect</span>\n\t\t\t</a>\n\t\t</div>\n\t</div>\n\t\n\t<div id="rc-feedback">\n\t\t<div id="rc-feedback-close" class="rc-can-press"></div>\n\t\t<div id="rc-feedback-vote">\n\t\t\t<div id="rc-feedback-round">\n\t\t\t\t<div id="rc-feedback-vote-question"></div>\n\t\t\t\t<div id="rc-feedback-vote-buttons">\n\t\t\t\t\t<div id="rc-feedback-vote-yes" data-value="1" class="rc-feedback-button">Да</div>\n\t\t\t\t\t<div id="rc-feedback-vote-no" data-value="0" class="rc-feedback-button">Нет</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div id="rc-feedback-comment" class="rc-feedback-block">\n\t\t\t<div id="rc-feedback-comment-question"></div>\n\t\t\t<div id="rc-feedback-comment-open-field">Оставить комментарий оператору</div>\n\t\t\t<div id="rc-feedback-comment-field">\n\t\t\t\t<textarea id="rc-feedback-comment-txt"></textarea>\n\t\t\t</div>\n\t\t\t<a href="javascript:void(0)" id="rc-feedback-comment-button">\n\t\t\t\t<span class="rc-txt">Отправить</span>\n\t\t\t</a>\n\t\t\t<div id="rc-feedback-copyright">\n\t\t\t\t<a id="rc-feedback-copyright-wrap" href="//redconnect.ru/?cp=f1" target="_blank">\n\t\t\t\t\t<span class="rc-txt">Сервис предоставлен <span id="rc-feedback-copyright-red">Red</span>Connect</span>\n\t\t\t\t</a>\n\t\t\t</div>\t\t\t\n\t\t</div>\n\t\t<div id="rc-feedback-complete" class="rc-feedback-block">\n\t\t\t<div id="rc-feedback-complete-text"></div>\n\t\t</div>\n\t</div>\t\n\n\t<div id="rc-phone" class="rc-inactive" style="display: none;">\n\t\t<div id="rc-phone-highlight"></div>\n\t\t<div id="rc-phone-back" class="rc-colorify"></div>\n\n\t\t<div id="rc-phone-dial" style="display: none">\n\t\t\t<div id="rc-phone-dial-snake">\n\t\t\t\t<div id="rc-phone-dial-snake-curtain">\n\t\t\t\t\t<div id="rc-phone-dial-half-circle">\n\t\t\t\t\t\t<div id="rc-phone-dial-circle"></div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-dial-snake-curtain2">\n\t\t\t\t\t<div id="rc-phone-dial-half-circle2">\n\t\t\t\t\t\t<div id="rc-phone-dial-circle2"></div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div id="rc-phone-dial-close" class="rc-can-press"></div>\n\t\t\t<div id="rc-phone-dial-cnt">\n\t\t\t\t<div id="rc-phone-dial-ok">\n\t\t\t\t\t<div id="rc-phone-dial-ok-curtain"></div>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-dial-fail">\n\t\t\t\t\t<div id="rc-phone-dial-fail-descr">\n\t\t\t\t\t\t<span class="rc-txt">\n\t\t\t\t\t\t\tСейчас нет свободных операторов, мы позвоним вам в ближайшее возможное время.\n\t\t\t\t\t\t</span>\n\t\t\t\t\t\t<div id="rc-phone-dial-fail-cancel">\n\t\t\t\t\t\t\tОтмена\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-dial-timer">\n\t\t\t\t\t<span class="rc-txt">00:28.00</span>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-dial-descr">\n\t\t\t\t\t<span class="rc-txt">Соединяем с оператором...</span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div id="rc-phone-appointment" style="display: none">\n\t\t\t<div id="rc-phone-appointment-close" class="rc-can-press"></div>\n\t\t\t<div id="rc-phone-appointment-body">\n\t\t\t\t<div id="rc-phone-appointment-message" class="rc-txt rc-no-select"></div>\n\t\t\t\t<div id="rc-phone-appointment-promise">\n\t\t\t\t\t<span class="rc-txt rc-no-select"></span> <span id="rc-phone-appointment-schedule" class="rc-txt rc-no-select">в назначенное время</span>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-appointment-ok">\n\t\t\t\t\t<div id="rc-phone-appointment-ok-curtain"></div>\n\t\t\t\t</div>\n\t\t\t\t<div id="rc-phone-appointment-cancel">\n\t\t\t\t\t<a class="rc-txt">Отменить</a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t\n\t\t<div id="rc-move-background"></div>\n\n\t\t<div id="rc-phone-form" style="display: none;">\n\t\t\t<div id="rc-phone-form-flash">\n\t\t\t\t<div id="rc-phone-form-flash-el"></div>\n\t\t\t</div>\n\t\t\t<div id="rc-phone-form-close" class="rc-can-press"></div>\n\t\t\t<div id="rc-phone-form-wrap-curtain" class="rc-parent-form">\n\t\t\t\t<div id="rc-phone-form-wrap" class="rc-parent-form">\n\t\t\t\t\t<div id="rc-scheduler" class="rc-no-select">\n\t\t\t\t\t\t<div id="rc-time-picker">\n\t\t\t\t\t\t\t<div id="rc-time-picker-header">\n\t\t\t\t\t\t\t\t<span class="rc-txt"></span>\n\t\t\t\t\t\t\t\t<span id="rc-time-picker-close"></span>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div id="rc-time-picker-body">\n\t\t\t\t\t\t\t\t<div class="rc-txt"></div>\n\t\t\t\t\t\t\t\t<select id="rc-time-picker-date"></select>\n\t\t\t\t\t\t\t\t<span class="rc-txt"></span>\n\t\t\t\t\t\t\t\t<select id="rc-time-picker-hour"></select>\n\t\t\t\t\t\t\t\t<span class="rc-txt">:</span>\n\t\t\t\t\t\t\t\t<select id="rc-time-picker-minute"></select>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div id="rc-time-picker-bottom"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<span class="rc-txt">Перезвоним за 28 секунд!</span>\n\t\t\t\t\t\t<a id="rc-select-time"></a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div id="rc-connector-container">\n\t\t\t\t\t\t<div id="rc-phone-input-warning">\n\t\t\t\t\t\t\t<div id="rc-phone-input-warning-header"><span class="rc-txt">Внимание!</span></div>\n\t\t\t\t\t\t\t<div id="rc-phone-input-warning-mid">\n\t\t\t\t\t\t\t\t<span class="rc-txt">Проверьте правильность набранного номера</span>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div id="rc-phone-input-warning-bottom"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<iframe class="rc-connector-frame"></iframe>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div id="rc-phone-button" class="rc-trigger rc-no-select rc-can-press">\n\t\t\t\t\t<div id="rc-phone-button-icon"></div>\n\t\t\t\t\t\t<span class="rc-txt"></span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div id="rc-copyright">\n\t\t\t\t<a id="rc-copyright-wrap" href="//redconnect.ru/?cp=w1" target="_blank">\n\t\t\t\t\t<span class="rc-txt">Сервис предоставлен <span id="rc-copyright-red">Red</span>Connect</span>\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div id="rc-svg-icon" style="display: none;">\n\t\t<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80" version="1.1">\n\t\t\t<path fill="#333333" transform="translate(42.734279, 41.499449) rotate(120.000000) translate(-42.734279, -41.499449)"\n\t\t\t\t\td="M27.9 50.2C26.6 50.9 26 50.9 25 49.7 24.7 49.4 24.8 49.1 25.1 48.9 28 47.3 29.8 46.2 32.3 44.8 32.5 44.6 32.8 44.5 33.1 44.5 33.3 44.4 33.6 44.6 33.7 44.7 34.1 45.6 33.6 46.9 32.7 47.4 31.9 47.9 30.8 48.5 30.2 48.8 29.6 49.2 28.7 49.8 27.9 50.2ZM57.5 50.2C58.8 50.9 59.4 50.9 60.4 49.7 60.7 49.4 60.7 49.1 60.3 48.9 57.4 47.3 55.6 46.2 53.2 44.8 52.9 44.6 52.6 44.5 52.3 44.5 52.2 44.4 51.8 44.6 51.8 44.7 51.4 45.6 51.9 46.9 52.7 47.4 53.6 47.9 54.6 48.5 55.2 48.8 55.9 49.2 56.8 49.8 57.5 50.2ZM60.9 47.9C59.2 46.9 54.9 44.4 52.9 43.3 52.7 43.1 52.4 42.8 52.4 42.5 52.1 40.7 50.9 39.3 49 39.3 46.9 39.3 44.8 39.2 42.7 39.2 40.7 39.2 38.6 39.3 36.5 39.3 34.6 39.3 33.4 40.7 33.1 42.5 33.1 42.8 32.8 43.1 32.6 43.3 30.6 44.4 27.1 46.4 24.6 47.8 24.3 48 23.7 47.8 23.4 47 23.2 46.4 23.1 45.8 23 45.2 22.3 41.7 23.6 38 26.8 36.4 28.7 35.4 30.7 34.6 32.7 33.9 35.9 32.6 39.3 32.3 42.7 32.4 46.2 32.3 49.5 32.6 52.8 33.9 54.8 34.6 56.8 35.4 58.7 36.4 61.9 38 63.2 41.7 62.5 45.2 62.4 45.8 61.9 46.9 61.7 47.5 61.6 47.8 61.2 48 60.9 47.9Z"></path>\n\t\t</svg>\n\t</div>\n\t<div id="rc-svg-emoticon" style="display: none">\n\t\t<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 84 84" version="1.1">\n\t\t\t<g>\n\t\t\t\t<circle stroke="#B3282D" stroke-width="4" fill="#F5F5F5" cx="40" cy="40" r="40"></circle>\n\t\t\t\t<ellipse fill="#B3282D" cx="56.42" cy="41.81" rx="6.17" ry="6.17"></ellipse>\n\t\t\t\t<ellipse fill="#B3282D" cx="23.21" cy="41.81" rx="6.17" ry="6.17"></ellipse>\n\t\t\t\t<path stroke="#B3282D" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none" d="M25.13 64.32C25.13 64.32 31.24 59.14 39.85 59.14 48.47 59.14 54.58 64.32 54.58 64.32"></path>\n\t\t\t</g>\n\t\t</svg>\n\t</div>\n\n</template>';
  }),
  redhelper.define(
    'view/view',
    [
      ...
      'application/api',
      'view/color-scheme',
      'text!common/../../connect/template.html',
    ],
    function (a, b, c, d) {
      var e = !1,
        f = !1,
        ...
        h = function () {},
        i = function (a) {
          if ('function' == typeof a) i.listeners.push(a);
          else for (var b = 0; b < i.listeners.length; b++) i.listeners[b](a);
        };
      i.listeners = [];
      var j = {
        init: function () {
          (j.render(), j.behavior(), c.apply());
        },
        onCallRequest: function (a) {
          h = a;
        },
        requestCall: function (a, b) {
          h(a, b);
        },
        onRender: function (a) {
          e ? a() : g.push(a);
        ...
        render: function () {
          (a('head')
            .append('<style>.country-list.hide { display: none; } </style> ')
            .append(a('<style>#rc-connect { display: none; }</style>'))
            .append(a('<style>.rc-button { display: none; }</style>'))
            .append(
              '<link type="text/css" rel="stylesheet" href="' +
                b.url +
                '/connect' +
                (b.uiVersion > 0 ? '/v' + b.uiVersion : '') +
                '/css/common.css?v=3.2.1.1606353591205"/>'
            ),
            (d = d.replace(/<template/i, '<div')),
            (d = d.replace(/\/template/i, '/div')),
            (d = a(d).attr({ id: 'rc-connect', class: 'rc-reset' })),
            b.hideActiveCopyright
              ? (d.find('a#rc-popup-copyright-wrap').removeAttr('href'),
                d.find('a#rc-feedback-copyright-wrap').removeAttr('href'),
                d.find('#rc-copyright-wrap').removeAttr('href'))
              : (d
                  .find('a#rc-popup-copyright-wrap')
                  .attr('href', b.copy.link + '?cp=p1')
                  .find('.rc-txt')
                  .html(b.copy.content),
                d
                  .find('a#rc-feedback-copyright-wrap')
                  .attr('href', b.copy.link + '?cp=f1')
                  .find('.rc-txt')
                  .html(b.copy.content),
                d
                  .find('#rc-copyright-wrap')
                  .attr('href', b.copy.link + '?cp=w1')
                  .find('.rc-txt')
                  .html(b.copy.content)),
            d.addClass('rc-lang-' + b.language),
            a('*', d).addClass('rc-reset'));
          var c = a('.rc-widget-container');
          (c.length
            ? ((b.widgetPosition = 'relative'),
              (b.ignorePosition = !0),
              c.append(d))
            : a('body').append(d),
            ~b.userInfo.browser.indexOf('XP') &&
              a('#rc-connect').addClass('rc-xp'),
            'offline' == b.status &&
              a('#rc-connect').addClass('rc-unavailable'),
            (e = !0));
          for (var f; (f = g.pop()); ) f();
        ...
        behavior: function () {
          function c(a) {
            (a.attr('type', 'tel'), a.addClass('rc-tel-initialized'));
            var c = 'ru';
            (b.countryCode && (c = b.countryCode.toLowerCase()),
              a.intlTelInput({ defaultCountry: c }),
              a.intlTelInput('utilsLoaded'),
              a.parents('._27').addClass('intl-tel-input'));
          }
          a(function () {
            (c(a('input.rc-tel-input').not('.rc-tel-initialized')),
              setInterval(function () {
                c(a('input.rc-tel-input').not('.rc-tel-initialized'));
              }, 1e3),
              a('.rc-input-trigger').on('keyup', function (b) {
                13 == (b.which || b.keyCode) &&
                  a(this)
                    .closest('div.rc-parent-form')
                    .find('.rc-trigger')
                    .click();
              }),
              a(document).on('mouseup', function () {
                a('.rc-pressed').removeClass('rc-pressed');
              }),
              a('.rc-can-press').on('mousedown', function () {
                a(this).addClass('rc-pressed');
              }));
          });
        },
        showView: function (c) {
          j.onStatus(c);
          var d = a('.rc-button-container'),
            e = a('#rc-feedback');
          (d.show(),
            (f = !0),
            a('#rc-connect').removeClass('rc-unavailable'),
            !b.enabled ||
              (e.length && e.is(':visible')) ||
              a('#rc-phone').show());
        },
        hideView: function () {
          (a('.rc-button-container').hide(),
            (f = !1),
            a('#rc-connect').addClass('rc-unavailable'),
            a('#rc-phone').hide());
        },
  ...
  redhelper.define(
    'view/warning',
    ['jquery-private', 'application/api'],
    function (a, b) {
      var c = {
        el: function () {
          return a('#rc-popup-form-input-warning, #rc-phone-input-warning');
        },
        open: function (d) {
          (a('#rc-phone-input-warning-header')
            .find('.rc-txt')
            .text(b.textMessages.warningHeader),
            c
              .el()
              .addClass('rc-active')
              .children(
                '#rc-phone-input-warning-mid, #rc-popup-form-input-warning-mid'
              )
              .children('.rc-txt')
              .text(d));
        },
        close: function () {
          c.el().removeClass('rc-active');
        },
        show: function (a) {
          (c.el().hide(),
            c.open(a),
  ...
  redhelper.define(
    'view/mobile',
    ['jquery-private', 'application/api', 'view/view'],
    function (a, b, c) {
      function d() {
        var c = a('#rc-connect').width();
        if ('online' != b.status && !b.letsTalkAt) return void e.hide();
        if (!c) return void setTimeout(d, 300);
        var h = 0.8,
          i = g.getZoom(),
          j = 1 / i,
          k = 'scale(' + j * h + ')';
          ...
          g.isNarrowEx()
            ? e.css({
                left:
                  ...
                  Math.round(f / 2) -
                  (i > 0.2 ? 11 : 0),
                top: window.pageYOffset + 1.0245 * window.innerHeight - 42.578,
              })
            : e.css({
                left:
                  window.pageXOffset +
                  window.innerWidth -
                  0.0847 * window.innerWidth -
                  41.277 +
                  (2.1439 * i * i - 17.651 * i + 39.583),
                top:
                  window.pageYOffset +
                  window.innerHeight +
                  0.0286 * window.innerHeight -
                  40.303,
              }),
          e.removeClass('rc-hidden'));
      }
      var e,
        f = 60,
        g = {
      ...
      return (
        c.onRender(function () {
          if (
            g.isMobile() &&
            ((e = a('#rc-phone')),
            e.addClass('rc-mobile').css('background', 'none'),
            !g.isNarrow() && b.enabled)
          ) {
            var c,
              h = Date.now();
            a(window).on(
              'scroll resize gesturestart touchmove gesturechange',
              function (a) {
                ((h = Date.now()),
                  e.addClass('rc-hidden'),
                  'resize' == a.type &&
                    (g.isNarrowEx()
                      ? e.css({
                          left:
  ...
  redhelper.define('application/postMessage', ['jquery'], function (a) {
    var b = '__rhlp_rc_';
    return {
      send: function (c, d, e, f) {
        var g = Date.now(),
          h = { command: d, id: g, data: e };
        if ((c.postMessage(b + JSON.stringify(h), '*'), f)) {
          var i = function (b) {
            var c = b.originalEvent.data;
            c.command == d + '-callback' &&
              c.id == g &&
              (a(window).off('message', i), f(c.data));
          };
          a(window).on('message', i);
        }
      },
      subscribe: function (c, d, e) {
        a(window).on('message', function (a) {
          var f = a.originalEvent.data;
          if ('string' == typeof f && 0 == f.indexOf(b)) {
            var g = JSON.parse(f.substring(b.length)),
              h = a.originalEvent.source;
            h == c &&
              g.command == d &&
              e(g.data, function (a) {
                h.postMessage(
                  { command: g.command + '-callback', id: g.id, data: a },
                  '*'
                );
              });
          }
  ...
  redhelper.define(
    'view/connectorContainer',
    ['jquery-private', 'application/api', 'application/postMessage'],
    function (a, b, c) {
      var d = localStorage.getItem('rc-user-phone');
      return {
        initConnector: function (e, f) {
          var g = e[0].contentWindow,
            h = !1,
            i = function () {},
            j = function () {},
            k = function (a) {},
            l = {
              countryCode: encodeURIComponent(b.countryCode),
              textPlaceholder: encodeURIComponent(b.textPlaceholder),
              backend: ~b.backend.indexOf('test')
                ? 'test'
                : ~b.backend.indexOf('development')
                  ? 'development'
                  : 'prod',
            };
          (f && (l.cssName = encodeURIComponent(f)),
            d &&
              ((l.phone = encodeURIComponent(d)),
              localStorage.removeItem('rc-user-phone')),
            e.attr(
              'src',
              b.url +
                '/connect/v2/connector.html?v=3.2.1.1606353591205&' +
                a.param(l)
            ));
          var m = {
            onInteraction: function (a) {
              return ((i = a), m);
            },
            onActivation: function (a) {
              return ((j = a), m);
            },
            onFocus: function (a) {
              return ((k = a), m);
            ...
            call: function (a, d) {
              ...
              c.send(g, 'call', e, function (a) {
                var c = a && a.callId,
                  e = a && a.status;
                ('error' == e && b.log.error(a.message), d(c, e));
              });
            },
            loadUserPhone: function () {
              c.send(g, 'load-user-phone');
            },
            validateUserPhone: function (a) {
              c.send(g, 'validate-phone', null, function (b) {
                a(b);
              });
            },
            rescale: function (a) {
              c.send(g, 'set-font-size', a);
            },
          };
          return (
            c.subscribe(g, 'init-phone-frame', function () {
              'function' == typeof b.connectorFrameReady &&
                b.connectorFrameReady(e);
            }),
            c.subscribe(g, 'phone-input-keyup', function (a) {
              (i(), 13 == a && j());
            }),
            c.subscribe(g, 'phone-input-focus-changed', function (a) {
              ((h = a), k(a));
            }),
            m
          );
  ...
  redhelper.define('model/timeFormatter', ['application/api'], function (a) {
    function b(a) {
      return ((a = a.toString()), a.length > 1 ? a : '0' + a);
    }
    function c(a) {
      var b = a.split(/\D+/);
      return 3 == b.length
        ? new Date(b[0], b[1] - 1, b[2])
        : new Date(b[0], b[1] - 1, b[2], b[3], b[4]);
    }
    function d(a, b) {
      return (
    ...
    var f = 864e5,
      g = {
        formatAbsoluteDate: function (a) {
          var d = c(a);
          return [d.getFullYear(), b(d.getMonth() + 1), b(d.getDate())].join(
            '-'
          );
        },
        formatRelativeDate: function (b) {
          var f = new Date(),
            g = c(b);
          return d(g, f)
            ? a.time.today
            : d(g, e(f))
              ? a.time.tomorrow
              : g.getDate() + '&nbsp;' + a.time.months[g.getMonth()];
        },
        formatHour: function (a) {
          return b(c(a).getHours());
        },
        formatMinute: function (a) {
          return b(c(a).getMinutes());
        },
        formatRelativeTime: function (b) {
          return b
            ? g.formatRelativeDate(b) +
                ' ' +
                a.time.timePrep +
                '&nbsp;' +
                g.formatHour(b) +
        ...
        formatTime: function (a) {
          var c = new Date(a);
          return (
            [c.getFullYear(), b(c.getMonth() + 1), b(c.getDate())].join('-') +
            ' ' +
            b(c.getHours()) +
            ':' +
            b(c.getMinutes())
  ...
  redhelper.define(
    'model/call',
    ['jquery-private', 'model/timeFormatter'],
    function (a, b) {
      var c = {
        load: function () {
          return JSON.parse(localStorage.getItem('rc_latest_call')) || {};
        },
        save: function (a) {
          localStorage.setItem('rc_latest_call', JSON.stringify(a));
        },
        remove: function (a) {
          localStorage.removeItem('rc_latest_call');
        },
        newCall: function (a, b, d) {
          var e = { placedAt: a, popupMode: b, state: 'PLACED' };
          (d && (e.time = d), c.save(e));
        },
        setId: function (a) {
          var b = c.load();
        ...
        isStale: function (a) {
          return a.placedAt && Date.now() - a.placedAt > 24e5;
        },
        isOngoing: function (b) {
          return (
            (b = b || c.load()),
            !c.isStale(b) &&
              ~a.inArray(b.state, [
        ...
        isScheduled: function (a) {
          return (
            (a = a || c.load()),
            a.time &&
              Date.now() < c.getScheduledTime(a) &&
              'SCHEDULED' == a.state
          );
        },
        getScheduledTime: function (a) {
          return ((a = a || c.load()), a.time ? b.parseTime(a.time) : void 0);
        },
        setFeedbackReceived: function () {
          var a = c.load();
          ((a.feedbackReceived = !0), c.save(a));
        },
        setWarningShown: function () {
          var a = c.load();
          ((a.warningShown = !0), c.save(a));
        },
      };
      return c;
    }
      ...
      var e = '',
        ...
        i = {
          request: function (b, d) {
            try {
              a.getJSON(
                c.backend + b + (~b.indexOf('?') ? '&' : '?') + 'callback=?',
                d
              );
            } catch (a) {
              c.log.error(a);
          ...
          feedback: function (b) {
            g && i.request('/call/' + g + '/update-feedback?' + a.param(b));
          },
          getStatus: function (a) {
            i.request(
              '/status/' + c.widgetId + '?timeShift=' + i.getTimeShift(),
              function (b) {
                a(b || {});
              }
            );
          },
          setCallId: function (a) {
            g = a;
          },
          watchCallState: function () {
            var a = function () {},
              d = function () {},
              j = function () {},
              k = function () {},
              l = function () {},
              m = function () {};
            if (!g) return void c.log.error('No callId not defined.');
            var n = {
                PLACED: function () {
                  a({ text: c.textMessages.wait });
                },
                CALLING_OPERATOR: function () {
                  a({ text: c.textMessages.callingOperator });
                },
                CALLING_VISITOR: function () {
                  ((f = Date.now()),
                    a({ text: c.textMessages.callingVisitor }));
                },
                OPERATOR_UNAVAILABLE: function () {
                  (j({ text: c.textMessages.operatorUnavailable }),
                    clearInterval(h));
                },
                VISITOR_UNAVAILABLE: function () {
                  (j({ text: c.textMessages.visitorUnavailable }),
                    clearInterval(h));
                },
                OPERATOR_HANGUP: function () {
                  (j(
                    'CALLING_VISITOR' == e && Date.now() - f > 15e3
                      ? { text: c.textMessages.visitorUnavailable }
                      : 'CALLING_OPERATOR' == e
                        ? { text: c.textMessages.operatorUnavailable }
                        : { text: c.textMessages.operatorHangup }
                  ),
                    clearInterval(h));
                },
                CONNECTED: function () {
                  d({ text: c.textMessages.talkInProgress });
                },
                FINISHED: function () {
                  (l({ free: !1 }), clearInterval(h));
                },
                FREE_FINISHED: function () {
                  (l({ free: !0 }), clearInterval(h));
                },
                FREE_CONNECTED: function () {
                  (l({ free: !0 }), clearInterval(h));
                },
                BANNED: function () {
                  (m(), clearInterval(h));
                ...
                default: function () {
                  (j({ text: c.textMessages.connectionFailed }),
                    clearInterval(h));
                },
              },
              o = 1e3;
            ((h = setInterval(function () {
              function a(a) {
                a.state !== e && (n[a.state] ? n[a.state]() : n.default());
              }
              var c = b.load();
              c.stateCheckedAt && Date.now() - c.stateCheckedAt < 0.9 * o
                ? a(c)
                : ((c.stateCheckedAt = Date.now()),
                  b.save(c),
                  i.request(
                    '/call/state?id=' + encodeURIComponent(g),
                    function (d) {
                      ((c.stateCheckedAt = Date.now()),
                        (c.state = d.state),
                        b.save(c),
              ...
              setTimeout(function () {
                'CALLING_OPERATOR' == e && k({ text: c.textMessages.timeout });
              }, 1e3 * c.duration));
            var p = {
              changed: function (b) {
                return ((a = b), p);
          ...
          getAvailableCallTimes: function (a) {
            i.request(
              '/availableCallTimes/' +
                c.widgetId +
                '?timeShift=' +
          ...
          cancelCall: function (a) {
            i.request(
              '/call/' + encodeURIComponent(g) + '/cancel',
              function (b) {
                a(b || {});
              }
            );
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e) {
      return {
        initTimePicker: function (f, g) {
          var h = a('#rc-phone'),
            i = f.find('[id$=time-picker-header]'),
            j = f.find('[id$=time-picker-body]'),
            k = f.find('[id$=time-picker-bottom]'),
            l = f.find('[id$=time-picker-date]'),
            m = f.find('[id$=time-picker-hour]'),
            n = f.find('[id$=time-picker-minute]'),
            o = !1;
          (i.find('.rc-txt').html(b.textMessages.timePickerHeader),
            j.find('.rc-txt:eq(0)').html(b.textMessages.timePickerText),
            j.find('.rc-txt:eq(1)').html(b.time.timePrep));
          var p = {
            open: function () {
              ((o = !0), p.update(), f.addClass('rc-active'), l.focus());
            },
            close: function () {
              o && ((o = !1), f.removeClass('rc-active'));
            },
            isOpen: function () {
              return o;
            },
            update: function () {
              if (!g) {
                var a = d.colorToRgba(b.colorMain, 0.92),
                  c = d.multiply(
                    b.colorMain,
                    d.isDark(b.colorMain) ? 0.8 : 1.2
                  ),
                  e = d.colorToRgba(b.colorBack, 0.92);
                (j
                  .removeAttr('style')
                  .css({ backgroundColor: e })
                  .find('.rc-txt')
                  .removeAttr('style')
                  .css({ color: d.isDark(b.colorBack) ? '#fff' : '#000' }),
                  i.removeAttr('style').css({ backgroundColor: a }),
                  i
                    .find('.rc-txt')
                    .removeAttr('style')
                    .css({
                      color: d.isDark(b.colorMain) ? '#fff' : '#000',
                      textShadow: '0 1px 0 ' + c,
                    }));
                var f = h.hasClass('rc-top-left') || h.hasClass('rc-top-right');
                k.removeAttr('style').css({ backgroundColor: f ? a : e });
              }
            },
            promptTime: function (b, d) {
              function f() {
                (r(l, q(v), c.formatRelativeDate), i(s, v));
              }
              function g(a, b, c) {
                var d = {};
                return ((d[a] = {}), (d[a][b] = [c]), d);
              }
              function h(a, b) {
                if (a) {
                  for (var c = 0; c < b.length; c++) if (b[c] >= a) return b[c];
                  if (a > b[b.length - 1]) return b[b.length - 1];
                }
                return b[0];
              }
              function i(a, b) {
              ...
              function r(b, c, d) {
                ((d =
                  ...
                  c.forEach(function (c) {
                    b.append(a('<option />').val(c).html(d(c)));
                  }));
              }
              var s = c.formatAbsoluteDate(b),
                t = c.formatHour(b),
                u = c.formatMinute(b),
                v = g(s, t, u);
              (l.change(function () {
                ...
                f(),
                e.getAvailableCallTimes(function (a) {
                  ((v = a), f());
                }),
                p.open());
            },
          ...
          return (
            g ||
              (f.find('[id$=time-picker-close]').click(p.close),
              f.find('[id$=time-picker-ok]').click(p.close)),
            p
          );
        },
      };
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e, f, g) {
      ...
      c.onRender(function () {
        ((h = a('#rc-phone')),
          (i = a('#rc-popup')),
          (j = a('#rc-popup-form-button')),
          (k = a('#rc-popup-connector-frame')),
          (m = a('#rc-overlay')),
          (n = a('#rc-popup-text').find('.rc-txt')),
          (o = g.initTimePicker(a('#rc-popup-time-picker'), !0)),
          s.render(),
          s.behavior(),
          s.update(b));
      });
      var s = {
        ...
        update: function (c) {
          if (
            ('online' == c.status
              ? (n.text(b.popup.text),
                i.removeClass('rc-time-editable'),
                (p = void 0))
              : (n.text(b.popup.offlineText), i.addClass('rc-time-editable')),
            a('#rc-popup-form-input-warning-header')
              .find('.rc-txt')
              .text(b.textMessages.warningHeader),
            a('#rc-popup-time-picker')
              .find('.rc-txt:eq(0)')
              .text(b.time.timePrep),
            d.isMobile())
          )
            j.text(b.textButton).css('background-color', b.colorMain);
          else {
            var e = '#fff',
              f = a('#rc-svg-icon')
                .html()
                .replace('fill="#333333"', 'fill="' + e + '"'),
              g = window.btoa(f);
            j.css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + g + ')',
            });
          }
        },
        isOpen: function () {
        ...
        setShown: function () {
          ((sessionStorage.rc_opened = !0),
            (localStorage.rc_last_opened = Date.now()));
        },
        isOnForSession: function () {
          return (
            !sessionStorage.rc_opened &&
            (!localStorage.rc_last_opened ||
              Date.now() - localStorage.rc_last_opened > 36e5)
          );
        },
        isOnNow: function () {
          return (
            'online' == b.status || (!b.popup.disabledOffline && b.letsTalkAt)
          );
        },
        isOn: function () {
          return s.isOnForSession() && s.isOnNow() && !q;
        },
        behavior: function () {
          if (
            (m.on('click', function () {
            ...
            s.isOnForSession() || (sessionStorage.rc_opened = !0),
            d.isMobile())
          )
              ...
              setInterval(function () {
                !h &&
                  ...
                  s.isOpen() &&
                    i.animate(
                      {
                        marginTop: -Math.round(i.outerHeight() / 2),
                        marginLeft: -Math.round(i.outerWidth() / 2),
                      },
                      200
                    ));
              }, 500));
          }
          if (b.popup.enabled && b.popup.showOnExit && !d.isMobile()) {
            var n = !0;
            a(document)
              .mouseout(function (a) {
                if (s.isOn()) {
                  var b = a.relatedTarget || a.toElement;
                  (b && 'html' != b.nodeName.toLowerCase()) ||
                    ((n = !1),
                    setTimeout(function () {
                      n || (s.isOnForSession() && (s.setShown(), s.open()));
                    }, 100));
                }
              })
              .mousemove(function () {
          ...
          (b.popup.enabled &&
            setTimeout(function () {
              s.isOn() && (s.setShown(), s.open());
            }, 1e3 * +b.popup.timeout),
            a('#rc-popup-close').click(function () {
              s.close();
            }),
            (l = f
              .initConnector(k, 'connector-popup')
        ...
        open: function () {
          s.isOnNow() &&
            !q &&
            ('offline' == b.status && b.letsTalkAt
              ? (o.open(),
                o.promptTime(b.letsTalkAt, function (a) {
                  p = a;
                }))
              : o.close(),
            i.show(),
            d.isMobile()
              ? (s.rescale(),
                a('body').on('touchmove scroll', function (a) {
                  a.preventDefault();
                }))
              : h.addClass('rc-transparent'),
            a('body').children(':not(#rc-connect)').addClass('rc-blur'),
            setTimeout(function () {
              i.addClass('rc-popup_opened');
            }, 100),
            d.isMobile() ||
              (i.css({
                marginTop: -Math.round(i.outerHeight() / 2),
            ...
            e.hide(),
            h.hide(),
            r++ || b.trackEvent('popupOpened'));
        },
        close: function () {
          var c = a('#rc-feedback');
          (m.hide(),
            i.hide().removeClass('rc-popup_opened'),
            e.hide(),
            h.removeClass('rc-transparent'),
            !b.enabled || (c.length && c.is(':visible')) || h.show(),
            a('.rc-blur').removeClass('rc-blur'),
            d.isMobile() && a('body').off('touchmove scroll'),
            1 === r && b.trackEvent('popupClosed'));
        },
        rescale: function () {
          var b = d.getZoom(),
            c = (7.9832 * Math.pow(b, -0.942)).toFixed(1) + 'px',
            e = Math.ceil(15.419 * Math.pow(b, -0.964));
          (i.css({
            ...
            a('#rc-popup-form').css({ 'font-size': c }),
            l.rescale(c),
            a(
              '#rc-popup-close, #rc-popup-form-input-warning, #rc-popup-form-input-warning-mid, #rc-popup-form-input-warning-header'
            ).css({ 'font-size': e.toFixed(1) + 'px' }));
        },
      };
      return s;
    }
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e, f) {
      return {
        initScheduler: function (a) {
          var c,
            g,
            h,
            i = a.children('.rc-txt'),
            j = a.find('#rc-select-time'),
            k = b.textMain,
            l = e.initTimePicker(a.find('[id$=time-picker]')),
            m = function () {};
          j.text(b.textEdit).click(function () {
            (m(),
              l.isOpen()
                ? l.close()
                : l.promptTime(n.getTime(), function (a) {
                    ((h = a), n.update());
                  }));
          });
          var n = {
            update: function () {
              (i.html(k).css({
                color: d.isDark(b.colorBack) ? '#fff' : '#000',
                textShadow: '0 1px 0 ' + b.colorBack,
              }),
                'online' != b.status &&
                  i
                    .children('.rc-when')
                    .html(f.formatRelativeTime(n.getTime())));
            },
            updateStatus: function (a) {
              ((k = 'online' == a.status ? b.textMain : b.textOffline),
                (g = a.letsTalkAt),
                a.status != c && ((c = a.status), (h = void 0)),
                n.update());
            },
            getTime: function () {
              return h || g;
        ...
        mockScheduler: function (a) {
          a.children('.rc-txt').html(b.textMain);
        },
      };
    }
  ),
  redhelper.define(
    'text!common/../../connect/connector.html!strip',
    [],
    function () {
      return '<div id="rc-connect">\n\t<div id="rc-phone-field">\n\t\t<input type="tel" id="rc-phone-input" class="rc-input-trigger"/>\n\t</div>\n</div>\n';
    }
  ),
  redhelper.define(
    'view/phoneWidget',
    ...
    function (a, b, c, d, e, f, g, h, i, j) {
      ...
      (c.onRender(function () {
        ((l = a('#rc-phone')),
          (m = a('#rc-phone-form')),
          (n = a('#rc-phone-form-close')),
          (o = a('#rc-phone-icon')),
          (q = a('#rc-phone-button')),
          (r = a('#rc-phone-back')),
          (s = a('#rc-phone-form-flash')),
          (t = a('#rc-copyright-wrap')),
          (u = a('#rc-phone-form-wrap-curtain')),
          (k = h.initScheduler(a('#rc-scheduler'))),
          v.render(),
          v.behavior(),
          v.update(),
          b.enabled || l.hide());
      }),
        c.onStatus(function (a) {
          ('online' == a.status
            ? l.removeClass('rc-time-editable')
            : !b.disabledOffline && b.letsTalkAt
              ? l.addClass('rc-time-editable')
              : l.hide(),
            k.updateStatus(a));
        }));
      var v = {
        initConnectorFrame: function () {
          p = i
            .initConnector(l.find('.rc-connector-frame'))
            .onInteraction(function () {
              (e.hide(), g.setShown());
            })
            .onActivation(function () {
        ...
        render: function () {
          (v.initConnectorFrame(),
            v.hide(),
            localStorage.getItem('rc_closed') ||
              !b.enabled ||
              f.isMobile() ||
              (localStorage.getItem('rc_showed') &&
              Date.now() - +localStorage.getItem('rc_showed') < 3e4
                ? ((v.expanded = !0), u.css({ overflow: 'visible' }))
                : b.disableAutoExpanding ||
                  (localStorage.setItem('rc_showed', Date.now()),
                  setTimeout(function () {
                    v.expand();
                  }, 1e3 * b.timeout))),
            b.hideActiveCopyright
              ? t.removeAttr('href')
              : b.free && t.attr('href', t.attr('href').replace('w1', 'wf1')));
          var a = sessionStorage.getItem('rc-user-pos'),
            c = sessionStorage.getItem('rc-user-mx'),
            d = sessionStorage.getItem('rc-user-my');
          (a && (b.position = a),
            c && (b.marginX = c),
            d && (b.marginY = d),
            v.show());
        ...
        update: function () {
          var c = a('#rc-phone-widget-style');
          c.length ||
            (a('body').append(a('<style/>', { id: 'rc-phone-widget-style' })),
            (c = a('#rc-phone-widget-style')));
          var e = d.multiply(b.colorMain, 0.8),
            f = d.multiply(b.colorMain, d.isDark(b.colorMain) ? 0.8 : 1.2),
            g = d.colorToRgba(b.colorBack, 0.92);
          (c.html(
            '#rc-phone-button.rc-pressed:hover { background-color:' +
              e +
              '!important }'
          ),
            k.update(),
            d.isDark(b.colorBack) &&
              (l.addClass('rc-dark-back-color'),
              redconnect.free && t.find('.rc-txt').html(b.copy.free)),
            redconnect.free && l.addClass('rc-free'),
            q
              .css({ backgroundColor: b.colorMain, borderColor: e })
              .children('.rc-txt')
              .text(b.textButton)
              .css({
                color: d.isDark(b.colorMain) ? '#fff' : '#000',
                textShadow: '0 1px 0 ' + f,
              }),
            a('#rc-phone-form-flash-el').css({ background: b.colorMain }),
            m.removeAttr('style').css({ backgroundColor: g }),
            l.removeAttr('style').css({
              bottom: 'auto',
              left: 'auto',
              top: 'auto',
              right: 'auto',
              position: b.widgetPosition,
            }),
            'absolute' == b.widgetPosition ? n.hide() : n.show());
          var h = d.isDark(b.colorMain) ? '#fff' : '#333e48',
            i = a('#rc-svg-icon')
              .html()
              .replace('fill="#333333"', 'fill="' + h + '"'),
            j = window.btoa(i);
          if (
            (o.css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + j + ')',
            }),
            r.css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + j + ')',
              border: '3px solid ' + b.colorBack,
              backgroundColor: d.colorToRgba(b.colorMain, 0.9),
            }),
            a('#rc-phone-button-icon').css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + j + ')',
            }),
            !b.ignorePosition)
          ) {
            var p = b.position.split('-'),
              s = {};
            ((s[p[0]] = b.marginY),
              (s[p[1]] = b.marginX),
              l.css(s),
              'left' == p[1] ? m.css('left', -7) : m.css('right', 7));
          }
          (l.removeClass(
            'rc-top-left rc-top-right rc-bottom-left rc-bottom-right'
          ),
            l.addClass('rc-' + b.position),
            v.visible ? (v.hide(), v.show()) : v.hide());
        },
        behavior: function () {
          (v.allowMoving(),
            f.isMobile()
              ...
              : l.on('click', function () {
                  a('body').hasClass('rc-no-select') ||
                    l.hasClass('rc-dial-progress') ||
                    l.hasClass('rc-call-scheduled') ||
                    v.expand();
                }),
            n.click(function (a) {
              (a.stopPropagation(),
            ...
            q.click(function () {
              (e.hide(), k.collapse(), c.requestCall(p, k.getTime()));
            }),
            k.onInteraction(function () {
              e.hide();
            }),
            f.isMobile() ||
              setInterval(function () {
                p.isFocused() || k.isExpanded() || v.flash();
              }, 2e4));
        },
        allowMoving: function () {
          function c(a) {
            if (
              ((d += Math.abs(e - a.clientX) + Math.abs(f - a.clientY)),
              !(Date.now() - n < 300 && d < 100))
            ) {
              ...
              (b < 14 && (b = 14),
                ...
                c < 14 && (c = 14),
                c > j - 14 - m && (c = j - 14 - m),
                l.css({ bottom: 'auto', right: 'auto', left: b, top: c }));
            }
          }
          var d, e, f, g, h, i, j, k, m, n;
          l.on('mousedown', function (o) {
            !l.hasClass('rc-inactive') ||
              l.hasClass('rc-dial-shown') ||
              l.hasClass('rc-dial-progress') ||
              ((k = l.width()),
              (m = l.height()),
              (g = o.offsetX),
              ...
              (e = o.clientX),
              (f = o.clientY),
              a('body').addClass('rc-no-select'),
              a('#rc-move-background').show(),
              a(document)
                .on('mousemove', c)
                .one('mouseup', function () {
                  if (
                    (a(document).off('mousemove', c),
                    a('#rc-move-background').hide(),
                    setTimeout(function () {
                      (a('body').removeClass('rc-no-select'),
                        (d < 10 || Date.now() - n < 300) && l.trigger('click'));
                    }, 10),
                    !(d < 10 || Date.now() - n < 300))
                  ) {
                    var e = l.position(),
                      f = '';
                    (e.top > j / 2
                      ? ((f += 'bottom'), (b.marginY = j - m - e.top + 'px'))
                      : ((f += 'top'), (b.marginY = e.top + 'px')),
                      (f += '-'),
                      e.left > i / 2
                        ? ((f += 'right'),
                          (b.marginX = i - k - e.left - 13 + 'px'))
                        : ((f += 'left'), (b.marginX = e.left + 'px')),
                      (b.position = f),
                      sessionStorage.setItem('rc-user-pos', b.position),
                      sessionStorage.setItem('rc-user-mx', b.marginX),
                      sessionStorage.setItem('rc-user-my', b.marginY),
                      v.update());
                  }
                }));
          });
        ...
        expand: function () {
          f.isMobile() ||
            (l.hasClass('rc-inactive') &&
              !v.expanded &&
              (l.removeClass('rc-inactive'),
              l.addClass('rc-expanded'),
              m.css('overflow', 'visible'),
              setTimeout(function () {
                u.css({ overflow: 'visible' });
              }, 300),
              (v.expanded = !0),
              localStorage.removeItem('rc_closed')));
        },
        collapse: function () {
          v.canCollapse &&
            (f.isMobile() ||
              (u.css({ overflow: 'hidden' }),
              l.removeClass('rc-expanded'),
              l.addClass('rc-inactive'),
              (v.expanded = !1),
              k.collapse(),
              localStorage.setItem('rc_closed', 1)));
        },
        show: function () {
          (l.toggleClass('rc-inactive', !v.expanded).show(),
            l.toggleClass('rc-expanded', v.expanded),
            (v.visible = !0));
        },
        hide: function () {
          (l.toggleClass('rc-inactive', !v.expanded).hide(),
            l.toggleClass('rc-expanded', v.expanded),
            (v.visible = !1));
        },
        open: function () {
        ...
        setStyle: function (c) {
          (a('body').addClass('rc-no-transition'),
            b.util.setValues(b, c),
            v.update(),
            setTimeout(function () {
              a('body').removeClass('rc-no-transition');
            }, 20));
        },
        mockPhoneButton: function (c, e, f) {
          ((c = a(c)), c.find('.rc-mock').remove());
          var g = r.clone();
          if (
            (c.addClass('rc-inactive'),
            g
            ...
            g.css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + j + ')',
              border: '3px solid ' + b.colorBack,
              backgroundColor: d.colorToRgba(e, 0.9),
            });
          }
          f && g.css({ border: '3px solid ' + f });
        },
        mockPhoneWidget: function (c, e, f) {
          c = a(c);
          var g = m.clone();
          (c.find('.rc-mock').remove(),
            c.addClass('rc-expanded'),
            g.find('#rc-phone-input').val(''),
            g
              .find('#rc-phone-input, #rc-phone-button')
            ...
            g
              .css({ position: 'relative', display: 'none' })
              .addClass('rc-mock'));
          var i = g.find('.rc-connector-frame'),
            k = a("<div class='rc-connector-frame rc-reset'></div>");
          (a(k).insertAfter(i), k.append(a(j).find('#rc-phone-field')));
          var l = b.countryCode ? b.countryCode.toLowerCase() : 'ru';
          if (
            (k.find('*').addClass('rc-reset'),
            k
              .find('#rc-phone-input')
              .prop('disabled', !0)
              .intlTelInput({ defaultCountry: l })
              .css({ cursor: 'auto' }),
            i.remove(),
            h.mockScheduler(g.find('#rc-scheduler')),
            c.append(g),
            e)
          ) {
            var n = d.multiply(e, 0.8),
              o = d.multiply(e, d.isDark(e) ? 0.8 : 1.2);
            g.find('#rc-phone-button')
              .css({ backgroundColor: e, borderColor: n })
              .children('.rc-txt')
              .css({
                color: d.isDark(e) ? '#fff' : '#000',
                textShadow: '1px 1px 0 ' + o,
              });
            var p = d.isDark(e) ? '#fff' : '#333e48',
              q = a('#rc-svg-icon')
                .html()
                .replace('fill="#333333"', 'fill="' + p + '"'),
              r = window.btoa(q);
            g.find('#rc-phone-button-icon').css({
              backgroundImage: 'url(data:image/svg+xml;base64,' + r + ')',
            });
          }
          if (f) {
            var s = d.colorToRgba(f, 0.92);
            (g.css({ backgroundColor: s }),
              g
                .find('#rc-scheduler')
                .children('.rc-txt')
                .css({
                  color: d.isDark(f) ? '#fff' : '#000',
                  textShadow: '1px 1px 0 ' + f,
                }),
              d.isDark(f)
                ? c.addClass('rc-dark-back-color')
                : c.removeClass('rc-dark-back-color'));
          }
        },
        flash: function () {
          (s.removeClass('rc-flash-move'),
            setTimeout(function () {
              s.addClass('rc-flash-move');
            }, 50));
        },
        wink: function () {
          (a('#rc-phone-form-wrap-curtain').addClass(
            'rc-phone-form-wrap-curtain_wink'
          ),
            setTimeout(function () {
              a('#rc-phone-form-wrap-curtain').removeClass(
                'rc-phone-form-wrap-curtain_wink'
              );
            }, 50));
        },
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e) {
      function f(a) {
        for (var b = 0; b < r.length; b++) r[b](a);
      }
      function g(a) {
        (t.isOpen() || t.open(), k.hide(), l.hide(), j.hide(), a && a.show());
      }
      function h() {
        i.css(
          a('#rc-phone').css(['position', 'top', 'right', 'bottom', 'left'])
        );
      }
      var i,
        j,
      ...
      d.onRender(function () {
        ((i = a('#rc-feedback')),
          (n = a('#rc-feedback-close')),
          (m = a('#rc-overlay')),
          (j = a('#rc-feedback-vote')),
          (k = a('#rc-feedback-comment')),
          (l = a('#rc-feedback-complete')),
          (o = a('#rc-feedback-vote-question')),
          (p = a('#rc-feedback-comment-question')),
          (q = a('#rc-feedback-complete-text')),
          t.render(),
          t.behavior(),
          t.update());
      });
      var t = {
        render: function () {
          (i.find('#rc-feedback-vote-yes').text(b.feedback.yes),
            i.find('#rc-feedback-vote-no').text(b.feedback.no),
            i
              .find('#rc-feedback-comment-open-field')
              .text(b.feedback.leaveComment));
        },
        update: function () {},
        setDescription: function (a, b) {
          'reached' == a || 'liked' == a
            ? o.text(b)
            : 'comment' == a
              ? p.text(b)
        ...
        behavior: function () {
          (m.on('click', function () {
            ...
            a('.rc-feedback-button').click(function (b) {
              var c = a(this).data('value');
              a(this).hasClass('rc-feedback-reached')
                ? (f({ reached: c }),
                  1 == c ? t.showLikedFeedback() : t.showExcuseFeedback())
                : a(this).hasClass('rc-feedback-liked') &&
                  (f({ liked: c }), t.showCommentFeedback(c));
            }),
            a('#rc-feedback-comment-button').click(function (b) {
              if (k.hasClass('rc-excuse') && !k.hasClass('rc-excuse-comment'))
                t.close();
              else {
                var c = a('#rc-feedback-comment-txt').val();
                (c && f({ comment: c }), t.commentFeedbackCompleted());
              }
            }),
            a('#rc-feedback-comment-open-field').click(function () {
              (k.addClass('rc-excuse-comment'),
                a('#rc-feedback-comment-button')
                  .find('.rc-txt')
                  .text(b.textSend),
                a('#rc-feedback-comment-txt').val('').focus());
            }));
        },
        closeOverlay: function () {
          (m.hide(), a('.rc-blur').removeClass('rc-blur'), c.hide());
        },
        close: function () {
          (m.hide(), i.hide(), a('.rc-blur').removeClass('rc-blur'), c.show());
        },
        open: function () {
          e.isMobile() ||
            (c.hide(),
        ...
        setButtonStyle: function (b) {
          'reached' == b
            ? a('.rc-feedback-button')
                .removeClass('rc-feedback-liked')
                .addClass('rc-feedback-reached')
            : 'liked' == b &&
              a('.rc-feedback-button')
                .removeClass('rc-feedback-reached')
                .addClass('rc-feedback-liked');
        },
        showReachedFeedback: function () {
          (g(j),
            n.removeClass('rc-feedback-close-square'),
            t.setDescription('reached', b.feedback.reachQuestion),
            t.setButtonStyle('reached'));
        },
        showLikedFeedback: function () {
          (g(j),
            n.removeClass('rc-feedback-close-square'),
            t.setDescription('liked', b.feedback.likeQuestion),
            t.setButtonStyle('liked'));
        },
        showCommentFeedback: function (c) {
          (void 0 === c && (c = !0),
            g(k),
            k.removeClass('rc-excuse rc-excuse-comment'),
            a('#rc-feedback-comment-button').find('.rc-txt').text(b.textSend),
            a('#rc-feedback-comment-txt').val('').focus(),
            n.addClass('rc-feedback-close-square'),
            t.setDescription(
              'comment',
              c ? b.feedback.commentQuestionLiked : b.feedback.commentQuestion
            ));
        },
        showExcuseFeedback: function () {
          (g(k),
            k.addClass('rc-excuse').removeClass('rc-excuse-comment'),
            a('#rc-feedback-comment-button').find('.rc-txt').text(b.textClose),
            n.addClass('rc-feedback-close-square'),
            t.setDescription('comment', b.feedback.excuse));
        },
        commentFeedbackCompleted: function () {
          (g(l),
            n.addClass('rc-feedback-close-square'),
            t.setDescription('complete', b.feedback.completeMessage),
            setTimeout(function () {
              t.close();
            }, 2e3));
        },
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e, f) {
      ...
      e.onRender(function () {
        ((g = a('#rc-phone-dial')),
          (j = a('#rc-phone-dial-cnt')),
          (k = a('#rc-phone-dial-circle, #rc-phone-dial-circle2')),
          (l = a('#rc-phone-dial-half-circle')),
          (m = a('#rc-phone-dial-half-circle2')),
          (n = a('#rc-phone-dial-fail')),
          (o = a('#rc-phone-dial-fail-cancel')),
          (p = a('#rc-phone-dial-close')),
          (r = a('#rc-phone')),
          (q = a('#rc-phone-back')),
          (h = a('#rc-phone-dial-timer').children('.rc-txt')),
          (i = a('#rc-phone-dial-descr').children('.rc-txt')),
          u.render(),
          u.behavior(),
          u.update());
      });
      var u = {
        render: function () {
          (r.removeClass('rc-dial-progress'), g.hide());
        },
        update: function () {
          (h.text('00:' + b.duration + '.00'),
            j.css({ backgroundColor: c.colorToRgba(b.colorBack, 0.9) }),
            i.css({ color: c.isDark(b.colorBack) ? '#fff' : '#333e48' }),
            u.setDescription(b.textMessages.wait),
            o.text(b.textClose),
            k.css({
              borderColor: c.isDark(b.colorMain) ? b.colorMain : '#333e48',
            }));
          var d = a('#rc-svg-emoticon')
              .html()
              .replace(/#F5F5F5/g, b.colorBack)
              .replace(/#B3282D/g, b.colorMain),
            e = window.btoa(d);
          n.css({ backgroundImage: 'url(data:image/svg+xml;base64,' + e + ')' })
            .find('.rc-txt')
            .text(b.textMessages.operatorUnavailable);
        },
        behavior: function () {
          (p.click(function () {
            return (u.close(), !1);
            ...
            q.click(function () {
              if (r.hasClass('rc-dial-progress')) return (u.open(), !1);
            }));
        },
        ...
        snakeListener: {
          ...
          to: 0,
          m: [],
          rotationAngles: function (a, b) {
            ((this.a = Math.round(1e3 * a) / 1e3),
              (this.b = Math.round(1e3 * b) / 1e3));
          },
          snakePosition: function (a) {
            this.pos = a;
          },
          deviation: function (a) {
            this.d = a;
          },
          adjustment: function (a, b) {
            ((this.from = a), (this.to = b));
          },
          matrix: function (a) {
            (2 == this.m.length && (this.m = []), this.m.push(a));
          },
          format: function () {
            return (
              '{time: ' +
        ...
        start: function (a) {
          function c(a) {
            var c = Math.floor(100 * (b.duration - a));
            if (c < 0) return void u.hideProgressTimer();
            var d = c % 100,
              e = Math.floor(c / 100);
            h.text('00:' + ('00' + e).substr(-2) + '.' + ('00' + d).substr(-2));
          }
          function e(a) {
            var c = u.getSnakePosition(),
              d = b.duration / 0.96,
              e = Math.floor(a / d) % 2 ? 1 : 0,
              f = Math.min(a % d, b.duration) + d * e,
              g = 0.5;
            Math.abs(f - c) > g &&
              g < f &&
              f < b.duration - g &&
              u.setSnakePosition(f);
          }
          ((s = !0),
            f.close(),
            r.show(),
            r.removeClass(
              'rc-dial-progress rc-dial-shown rc-dial-shown-long rc-dial-success rc-dial-failure'
            ),
            g.show(),
            setTimeout(function () {
              (r.addClass('rc-dial-progress rc-dial-shown'), d.collapse());
            }, 0),
            setTimeout(function () {
              s && r.addClass('rc-dial-progress rc-dial-shown-long');
            }, 1e3),
            clearInterval(t));
          var i = (Date.now() - a) / 1e3;
          (c(i),
            u.setSnakePosition(i),
            u.setDescription(b.textMessages.wait),
            setTimeout(function () {
              s &&
                (t = setInterval(function () {
                  var b = (Date.now() - a) / 1e3;
                  (c(b), e(b));
                }, 70));
            }, 500));
        },
        getSnakePosition: function () {
          function a(a) {
            var c = a.css('transform') || a.css('-webkit-transform');
            if (!c || 'none' == c) return 0;
            var d = c.split('(')[1].split(')')[0].split(',');
            return Math.atan2(d[1], d[0]) * (b.duration / 2 / Math.PI);
          }
          var c = a(l),
            d = a(m);
          return (
        ...
        setSnakePosition: function (a) {
          function c(a, b) {
            var c = a.parent();
            (a.remove(),
              setTimeout(function () {
                (a.css({ animationDelay: b + 's' }), c.append(a));
              }, 0));
          }
          (c(l, -a), c(m, b.duration / 2 - a));
        },
        hideProgressTimer: function () {
          (h.text('00:00.00'), r.addClass('rc-timeout'));
        },
        stop: function () {
          ((s = !1),
            b.enabled || r.hide(),
            r.removeClass(
              'rc-dial-progress rc-dial-shown rc-dial-shown-long rc-dial-success rc-dial-failure rc-timeout'
            ),
            g.css({ display: 'none' }),
            clearInterval(t),
            h.text('00:' + b.duration + '.00'),
        ...
        close: function () {
          r.removeClass('rc-dial-shown rc-dial-shown-long');
        },
        open: function () {
          r.addClass('rc-dial-shown rc-dial-shown-long');
        },
        freeSuccess: function () {
          setTimeout(function () {
            (u.setDescription(b.textMessages.callingVisitor),
              setTimeout(function () {
                (f.showReachedFeedback(), d.collapse(), u.stop());
              }, 1e3 * b.feedbackTimeout));
          }, 1e3 * b.feedbackStartTimeout);
        },
        success: function () {
          (u.open(),
            b.trackEvent('callSuccess'),
            setTimeout(function () {
              r.addClass('rc-dial-success');
            }, 0),
            setTimeout(function () {
              (b.feedbackEnabled && f.showLikedFeedback(),
                d.collapse(),
                u.stop());
            }, 3e3));
        },
        failure: function () {
          (b.trackEvent('callFailed'),
            u.stop(),
            g.show(),
            u.open(),
            setTimeout(function () {
              (r.addClass('rc-dial-failure'),
                r.removeClass('rc-dial-progress rc-dial-success'));
            }, 0));
        },
        mailed: function () {
          (setTimeout(function () {
            r.addClass('rc-dial-progress rc-dial-shown');
          }, 0),
            setTimeout(function () {
              r.addClass('rc-dial-success');
            }, 0),
            ...
            setTimeout(function () {
              (g.hide(),
                r.removeClass('rc-dial-success'),
                r.removeClass('rc-dial-progress rc-dial-shown'));
            }, 5e3));
        },
      };
      return u;
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e, f) {
      ...
      e.onRender(function () {
        ((g = a('#rc-phone')),
          (h = a('#rc-phone-appointment')),
          (i = a('#rc-phone-appointment-body')),
          (j = i.find('.rc-txt')),
          (k = a('#rc-phone-appointment-promise').find('.rc-txt:eq(0)')),
          (l = a('#rc-phone-appointment-message')),
          (m = a('#rc-phone-appointment-schedule')),
          (n = a('#rc-phone-appointment-cancel').children('a')),
          (o = a('#rc-phone-appointment-close')),
          (p = a('#rc-phone-back')),
          s.render(),
          s.behavior());
      });
      var s = {
        render: function () {
          (i.css({ backgroundColor: c.colorToRgba(b.colorBack, 0.9) }),
            j.css({ color: c.isDark(b.colorBack) ? '#fff' : '#333e48' }),
            k.html(b.textMessages.appointmentText),
            n.text(b.textCancel));
        },
        behavior: function () {
          (n.click(function () {
            ...
            g.click(function () {
              g.hasClass('rc-call-scheduled') && s.open();
            }));
        },
        start: function (a) {
          ((q = a),
            (r = !1),
            g.addClass('rc-call-scheduled'),
            l.text(b.textMessages.wait),
            setTimeout(function () {
              (h.show(), r || g.addClass('rc-waiting'));
            }, 350),
            setTimeout(function () {
              (g.addClass('rc-dial-shown'), d.collapse());
            }, 0));
        },
        confirm: function () {
          ((r = !0), g.removeClass('rc-waiting'), s.update());
        },
        end: function () {
          (s.close(), h.hide(), g.removeClass('rc-call-scheduled'));
        },
        onCancel: function () {
          s.cancel();
        },
        cancel: function (a) {
          (l.text(b.textMessages.callCancelled),
            g.addClass('rc-canceled'),
            setTimeout(function () {
              (s.end(), g.removeClass('rc-canceled'), a && a());
            }, b.noticeDuration));
        },
        resume: function (a) {
          ((q = a),
        ...
        close: function () {
          g.removeClass('rc-dial-shown rc-dial-shown-long');
        },
        open: function () {
          g.addClass('rc-dial-shown rc-dial-shown-long');
        },
        update: function () {
          m.html(f.formatRelativeTime(q));
        },
      };
      return s;
    }
  ...
  redhelper.define(
    ...
    function (a, b, c, d, e, f, g, h) {
      function i(c) {
        ...
        var e = d.width,
          f = a(window).width(),
          g = c.left + e > f ? f - e - 7 : c.left + 7;
        (d.setStyle({
          marginY: c.top - 7 + 'px',
          marginX: g - 7 + 'px',
          position: 'top-left',
          widgetPosition: 'absolute',
          colorMain: b.buttonWidget.colorMain,
          colorBack: b.buttonWidget.colorBack,
        }),
          d.show());
      }
      var j = a('.rc-button');
      !!j.length &&
        b.buttonWidget.enabled &&
        (c.onRender(function () {
          (p.render(), p.behavior());
        }),
        c.onStatus(function () {
          'online' == b.status
            ? (j.removeClass('rc-offline'),
              redconnect.free
                ? p.updateText(b.textFreeMain)
                : p.updateText(b.textMain),
              p.show())
            : !b.buttonWidget.disabledOffline && b.letsTalkAt
              ? (j.addClass('rc-offline'),
                p.updateText(b.textOfflineShort),
                p.show())
              : p.hide();
        }));
      var k = {},
        ...
        p = {
          render: function () {
            var c = a('.rc-button'),
              d = a('<div/>').addClass('rc-button-container'),
              e = a('<div/>').addClass('rc-button-wrap');
            (c.length &&
              b.buttonWidget.enabled &&
              (a('<div/>').addClass('rc-button-icon').appendTo(d),
              a('<div/>')
                .addClass('rc-button-text')
                .append(a('<span/>').addClass('rc-txt'))
                .appendTo(d),
              d.hide(),
              c.html(e.append(d))),
              p.update());
          ...
          update: function () {
            ...
            c.length &&
              ...
              (c.addClass(
                'rc-button-' +
                  b.buttonWidget.buttonStyle +
                  ' rc-button-' +
                  b.buttonWidget.size
              ),
              p.updateText(b.textMain),
              'transparent' != b.buttonWidget.buttonStyle &&
                a('.rc-button-container').css({
                  border: '1px solid ' + b.buttonWidget.colorBorder,
                  'background-color': b.buttonWidget.colorBack,
                }));
            var d = e.isDark(b.buttonWidget.colorMain) ? '#fff' : '#333e48',
              f = a('#rc-svg-icon')
                .html()
                .replace('fill="#333333"', 'fill="' + d + '"'),
              g = window.btoa(f);
            (a('.rc-button-icon').css({
              backgroundColor: b.buttonWidget.colorMain,
              backgroundImage: 'url(data:image/svg+xml;base64,' + g + ')',
            }),
              e.isDark(b.buttonWidget.colorMain) ||
                c.addClass('rc-with-green-button'),
              e.isDark(b.buttonWidget.colorBack) &&
                'transparent' != b.buttonWidget.buttonStyle &&
                c.addClass('rc-with-light-text'));
          },
          updateText: function (b) {
            a('.rc-button-text').children('.rc-txt').html(b);
          },
          show: function () {
            a('.rc-button-container').show();
          },
          hide: function () {
            a('.rc-button-container').hide();
          },
          ...
          behavior: function () {
            ...
            (e.click(function () {
              (a(this).hide(),
                ...
                d.collapse(),
                d.setStyle(k),
                a('#rc-phone').removeClass('rc-from-button'),
                a('.rc-blur').removeClass('rc-blur'),
                c.css('opacity', 1),
                (n = !1),
                m && d.show(),
                b.trackEvent('buttonClicked'));
            }),
              c.click(function () {
                if (!o) {
                  if (g.isMobile())
                  ...
                  ((d.canCollapse = !1),
                    a('#rc-phone').addClass('rc-from-button'),
                    g.isMobile() ||
                      a('body')
                        .children(':not(#rc-connect)')
                        .addClass('rc-blur'),
                    f.hide(),
  ...
  redhelper.requirejs(
    ...
    function (a, b, c, d, e) {
      return window.__rc_started
        ? (c.log.warn('Script already started!'), {})
        : window.attachEvent && !window.addEventListener
          ? (c.log.warn('Not supporting old browsers (<=IE8).'), {})
          : ((window.__rc_started = !0),
            a(function () {
              function f(a) {
                setTimeout(function () {
                  (b.warning.show(a), e.setWarningShown());
                }, 300);
              }
              function g() {
                d.watchCallState()
                  .changed(function (a) {
                    b.dial.setDescription(a.text);
                  })
                  .connected(function (a) {
                    (b.dial.hideProgressTimer(), b.dial.setDescription(a.text));
                  })
                  .finished(function (a) {
                    (a.free ? b.dial.freeSuccess() : b.dial.success(), j());
                  })
                  .timeout(function (a) {
                    (b.dial.hideProgressTimer(),
                      b.dial.setDescription(a.text),
                      j());
                  })
                  .failure(function (a) {
                    (a.text == c.textMessages.visitorUnavailable
                      ? (o ? b.popup.open() : b.phoneWidget.expand(),
                        b.dial.stop(),
                        f(a.text))
                      : b.dial.failure(),
                      j());
              ...
              function h() {
                (b.appointment.update(),
                  (p = setInterval(function () {
                    (b.appointment.update(),
                      e.getScheduledTime() <= Date.now() &&
                        (clearInterval(p),
                        b.appointment.end(),
                        b.dial.start(Date.now()),
                        g()));
                  }, 1e4)));
              }
              function i() {
                ((n = !0),
                  b.popup.setDisabled(!0),
                  b.buttonWidget.setDisabled(!0));
              }
              function j() {
                ((n = !1),
                  b.popup.setDisabled(!1),
                  b.buttonWidget.setDisabled(!1));
              }
              function k() {
                (b.dial.stop(),
                  j(),
              ...
              function l() {
                ...
                if (!n) {
                  var c = e.load();
                  (c.feedbackReceived && b.feedback.close(),
                    c.warningShown && b.warning.close(),
                    e.isOngoing(c)
                      ? (i(), (o = c.popupMode), b.dial.start(c.placedAt), a(g))
                      : e.isScheduled(c)
                        ? (i(), b.appointment.resume(c.time), a(h))
                        : b.dial.stop());
                }
              }
              function m() {
                d.getStatus(function (a) {
                  ((c.status = a.status),
                    (c.letsTalkAt = a.letsTalkAt),
                    'online' == c.status || c.letsTalkAt || e.isScheduled()
                      ? b.view.showView(a)
                      : b.view.hideView());
                });
              }
              ...
              (b.view.init(),
                b.feedback
                  .onFeedback(function (a) {
                    (d.feedback(a), e.setFeedbackReceived());
                  })
                  .onClose(function () {
                    e.setFeedbackReceived();
                  }),
                (b.appointment.onCancel = function () {
                  d.cancelCall(function (a) {
                    'ok' == a.result &&
                      (clearInterval(p),
                      e.set({ state: 'CANCELLED' }),
                      j(),
                      b.appointment.cancel(function () {
                        (b.phoneWidget.expand(), m());
                      }));
                  });
                }));
              var p;
              (b.view.onCallRequest(function (a, j) {
                n ||
                  a.validateUserPhone(function (l) {
                    if (!l) return void f(c.textMessages.wrongNumber);
                    (b.popup.isOpen() ? (b.popup.close(), (o = !0)) : (o = !1),
                      i());
                    var m = Date.now();
                    (e.newCall(m, o, j),
                      j ? b.appointment.start(j) : b.dial.start(m),
                      a.call(j, function (a, i) {
                        'ok' == i
                          ? (d.setCallId(a), e.setId(a), g())
                          : 'scheduled' == i
                            ? (d.setCallId(a),
                              e.set({ id: a, state: 'SCHEDULED' }),
                            ...
                            : 'banned' == i
                              ...
                              : 'invalid number' == i
                                ? (e.remove(),
                                  k(),
                                  f(c.textMessages.wrongNumber))
                                : 'emailed' == i
                                  ? (e.remove(), k(), b.dial.mailed())
                                  : (e.remove(), k());
                      }));
                  });
              }),
