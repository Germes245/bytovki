(function () {
  ...
  (function (e) {
    ...
    zt({ global: true }, { AggregateError: nn });
    ...
    var kn = function (e, t, r) {
      if (e && !le((e = r ? e : e.prototype), An)) {
        Xn(e, An, { configurable: true, value: t });
      }
    };
    var Nn = At.f;
    var Cn = Le.f;
    ...
    kn(zn, Mn);
    kn(Un, Dn);
    var vi = { ArrayBuffer: zn, DataView: Un };
    var yi = function () {};
    var mi = [];
    ...
    zt({ target: 'Object', stat: true }, { hasOwn: le });
    var Li = function (e) {
      var t, r;
    ...
    var zi =
      !!Hi &&
      a(function () {
        Hi.prototype['finally'].call({ then: function () {} }, function () {});
      });
    zt(
      { target: 'Promise', proto: true, real: true, forced: zi },
      {
        finally: function (e) {
    ...
    if (!Q && A(Hi)) {
      ...
      if (Hi.prototype['finally'] !== Gi) {
        ft(Hi.prototype, 'finally', Gi, { unsafe: true });
      }
    }
    var Ui = ge('iterator');
    var $i = false;
    ...
    var oo = r(function (e) {
      ...
      var O = function (e) {
        var t;
        return (
          P(p, e) || (t = Rr(e)) == 'ArrayBuffer' || t == 'SharedArrayBuffer'
        );
      };
      var X = function (e, t) {
      ...
      if (s) {
        ...
        e.exports = function (e, s, l) {
          ...
          C[h] = A;
          zt({ global: true, forced: A != X, sham: !y }, C);
          if (!(E in A)) {
            Me(A, E, p);
          }
          if (!(E in N)) {
    ...
    var Uo = function (e, t, r, n, i, a, s) {
      ...
      if (i) {
        y = { values: o(Wo), keys: a ? p : o(Ho), entries: o(zo) };
        if (s)
          for (m in y) {
            if (Fo || c || !(m in f)) {
              ft(f, m, y[m]);
        ...
        else zt({ target: t, proto: true, forced: Fo || c }, y);
      }
      if (f[Ro] !== p) {
        ft(f, Ro, p, { name: i });
      }
    ...
    var qo = Uo(
      ...
      'Array',
      function (e, t) {
        Vo(this, { type: $o, target: X(e), index: 0, kind: t });
      },
      function () {
        var e = Yo(this);
        var t = e.target;
    ...
    if (!Du) {
      ...
      if (!ou && !uu && !ku && Pu && _u) {
        ...
        new Pu(Fu).observe(Gu, { characterData: true });
        Wu = function () {
          Gu.data = zu = !zu;
        };
  ...
  (function (e) {
            ...
            if (!this.loadPromise && this.state) {
              ...
              this.settingsScripts.forEach((e) => {
                const t = !!document.querySelector(
                  `script[data-extension="${e.extension}"]`
                );
                if (!t) {
              ...
              this.loadPromise = Promise.all([
                H(this.externalScripts),
                H(this.externalStyles),
              ]).then(() => {
                this.state = 'loaded';
    ...
    function F(e) {
      return new Promise((t) => {
        BX.ajax.runAction(A, { data: e }).then(t);
      });
    }
    function R(e) {
      if (e.status !== 'success') {
    ...
    function W(e) {
      ...
      return F({ extension: t }).then(R).then(_).then(I);
    }
    const z = [
      '[object Object]',
      '[object Array]',
    ...
    const te = new Q({ defaultMaxListeners: 10 });
    const re = new ee();
    const ne = new Map();
    const ie = { GLOBAL_TARGET: 'GLOBAL_TARGET' };
    te.add(ie, { maxListeners: 25 });
    ...
    let me = (function () {
      ...
      babelHelpers.createClass(e, null, [
        ...
        },
        {
          ...
          value: function e() {
            return (
              ye.includes('ipad;') || (this.isMac() && this.isTouchDevice())
            );
          },
        },
        {
    ...
    function Se(e) {
      if (i.isString(e)) {
        if (i.isNil(Se[e])) {
          ue.emit('onBXMessageNotFound', new K({ compatData: [e] }));
          if (i.isNil(Se[e])) {
    ...
    function Ne(e) {
      ...
      if (t.type === 'tag') {
        ...
        t.children.forEach((t) => {
          const r = Ne({ node: t, parentElement: e, substitutions: n });
          if (i.isArray(r)) {
            r.forEach((t) => {
              ke(t, e);
            });
    ...
    function Ce(e, ...t) {
      ...
      const n = Ae(r);
      if (n.length === 1) {
        return Ne({ node: n[0], substitutions: t });
      }
      if (n.length > 1) {
        return n.map((e) => Ne({ node: e, substitutions: t }));
      }
      return false;
    }
    function Pe(e, ...t) {
    ...
    function ur(e, t, r) {
      ...
      t = t.toLowerCase();
      ue.subscribe(e, t, r, { compatMode: true, useGlobalNaming: true });
    }
    function lr(e, t, r, n) {
      if (i.isString(e)) {
        n = r;
      ...
      a.setData(r);
      a.setCompatData(r);
      ue.emit(e, t, a, { cloneData: n === true, useGlobalNaming: true });
    }
    function cr(e, t, r) {
      if (i.isString(e)) {
        r = t;
      ...
      t = t.toLowerCase();
      ue.unsubscribe(e, t, r, { useGlobalNaming: true });
    }
    function fr(e, t) {
      if (i.isString(e)) {
        t = e;
      ...
      t = t.toLowerCase();
      ue.unsubscribeAll(e, t, { useGlobalNaming: true });
    }
  ...
  (function (BX) {
    ...
    function loadAsyncEmulation(e, t, r) {
      ...
      function i(e) {
        if (e.state === undefined) {
          ...
          e.onpreload = [];
          loadAsset(
            { url: e.url, type: 'cache', ext: e.ext },
            function () {
              n(e);
            },
            r
    ...
    function loadAsset(e, t, r) {
      ...
      var s;
      var o = BX.type.isNotEmptyString(e.ext)
        ? e.ext
    ...
    function Trash() {
      ...
      for (e = 0, t = garbageCollectors.length; e < t; e++) {
        try {
          garbageCollectors[e].callback.apply(
            garbageCollectors[e].context || window
          );
  ...
  (function (e) {
      ...
      return o
        ...
        .then(function (e) {
          ...
          o.then(function () {
            ...
            var i = n.join('\n');
            t.html(document.head, i, { useAdjacentHTML: true }).then(
              function () {
                r.fulfill(e);
              }
            );
    ...
    t.userOptions.send = function (e) {
      ...
      if (r != '') {
        document.cookie =
          t.message('COOKIE_PREFIX') + '_LAST_SETTINGS=; path=/;';
        t.ajax({
          method: 'GET',
          dataType: 'html',
          processData: false,
